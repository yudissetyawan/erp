    ...
    if(isset($_POST[submit])){
     $direktori = '../fin/upload/vp/'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['filevp']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filevp']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filevp']['tmp_name']; //Nama file sementara
