    ...
    if(isset($_POST[submit2])){
     $direktori = '../fin/upload/ic/'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['fileic']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['fileic']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['fileic']['tmp_name']; //Nama file sementara
