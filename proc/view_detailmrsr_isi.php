...
<body id="printarea"> <!--
<?php
	if (($_SESSION['userlvl'] == 'ppic') || ($_SESSION['userlvl'] == 'administrator') && ($row_Recordset3['status_approval'] != 'W')) {
...
<thead>
  <tr align="center" class="tabel_header">
    ...
    <td width="266"><b>DESCRIPTION</b></td>
    <td width="67"><b>SPEC</b></td>
    <td width="40"><b>QTY</b></td>
    <td width="64"><b>DATE IN USE</b></td>
    <td width="69"><b>TO BE USED</b></td>
    <td width="62"><b>PROD CODE</b></td>
    <td><b>REMARK</b></td>
    <td>&nbsp;</td>
    <?php
	/*if (($_SESSION['userlvl'] == 'ppic') || ($_SESSION['userlvl'] == 'administrator') && ($row_Recordset3['status_approval'] != 'W')) {
  ...
  <tbody>
    <?php do { ?>
      <tr class="tabel_body"><?php $a=$a+1; ?>
        ...
        <td colspan="2"><?php echo $row_Recordset1['mtrl_model']; ?> (<?php echo $row_Recordset1['descr_name']; ?>) <?php echo $row_Recordset1['id_type']; ?> <?php echo $row_Recordset1['brand']; ?> <?php echo $row_Recordset1[descr_spec]; ?></td>
        ...
        <td width="102"><?php if ($row_Recordset1['status_itemmr']==1) { echo "<img src='../images/select(1).png' width='15' height='15' />"; } 
		  else { 
