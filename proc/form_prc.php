...
$query_Recordset1 = "SELECT * FROM a_proj_code WHERE complete=1 ORDER BY project_code";
  ...
  <tr>
    <td width="950"><p align="center">&nbsp;</p>
      ...
      <p>
		...
		$sql=mysql_query("SELECT * FROM a_crf WHERE (a_crf.approval='Y') AND (a_crf.projectcode LIKE '%$cari%') AND (a_crf.procurement=1)");
	  $totalseluruhpendaftar=mysql_num_rows($sql);
	  if($totalseluruhpendaftar=='0'){
	 echo "<center><blink>No data available in table </bink></center>";
      ...
      <table width="1042" border="0" cellspacing="1" cellpadding="0">
        <tr class="tabel_header">
          <th colspan="2" > <?
while($sql2=mysql_fetch_array($not)){
	  ?>
        ...
        <tr class="tabel_header">
          <th width="24" class="tabel_header">No.</th>
          <th width='89' class="tabel_header">Production Code</th>
          <th width="657" class="tabel_header">Job Title</th>
          <th width='87' class="tabel_header">&nbsp;</th>
          <th width='54' class="tabel_header">Vendor</th>
          <th width="55" class="tabel_header">Purchase Order</th>
          <th width="68" class="tabel_header">Vendor Invoice</th>
        </tr>
        <?
while($sql1=mysql_fetch_array($sql)){
	  ?>
        <tr class="tabel_body">
          ...
          <td><?php echo $sql1[projectcode] . " - " .$sql1[productioncode];?></td>
          <td ><a href="work_proc.php?data=<?php echo $sql1['nocrf'];?>" target="_blank"><b><?php echo $sql1[jobtitle];?></b></a></td>
          <td align="center"><a href="#" onClick="MM_openBrWindow('hasil_kerja.php?data=<?php echo $sql1['nocrf'];?>','','menubar=yes,scrollbars=yes,width=700,height=500')">View Attachment</a></td>
          <td >&nbsp;</td>
          <td ></td>
          <td></td>
        </tr>
