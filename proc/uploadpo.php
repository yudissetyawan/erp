    ...
    if(isset($_POST[submit2])){
     $direktori = '../proc/upload/po'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['filepo']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filepo']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filepo']['tmp_name']; //Nama file sementara
