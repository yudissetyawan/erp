    ...
    if(isset($_POST[submit3])){
     $direktori = '../proc/upload/vi'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['filevi']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filevi']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filevi']['tmp_name']; //Nama file sementara
