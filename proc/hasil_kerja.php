...
mysql_select_db($database_core, $core);
$query_Recordset1 = sprintf("SELECT * FROM dms WHERE idms = %s AND dms.id_departemen = 'proc'", GetSQLValueString($colname_Recordset1, "text"));
$Recordset1 = mysql_query($query_Recordset1, $core) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
...
<table width="650" border="1" align="center">
  ...
  <?php do { ?>
    <tr class="tabel_body"><?php $a = $a+1 ?>
      ...
      <td><a href="upload/<?php echo $row_Recordset1['fileupload']; ?>"><?php echo $row_Recordset1['fileupload']; ?></a></td>
