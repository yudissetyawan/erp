...
$MM_authorizedUsers = "administrator,branchmanager,procurement";
...
$MM_restrictGoTo = "/home.php?pesan=Sorry You re not Alowed to access Procurement Section";
...
<table width="1234" border="0" align="center">
  ...
  <tr>
    <td align="right" bgcolor="#8db4e3" class="tabel_index" id="font">Procurement Menu</td>
    <td colspan="2" align="right" bgcolor="#8db4e3" id="font">
    <table width="300" height="17" border="0" align="left" cellpadding="0" cellspacing="0">
      <tr class="tabel_index">
        <td width="36" bgcolor="#EFEFEF" class="root"><a href="../home.php">Home</a></td>
        <td width="5" align="right" bgcolor="#EFEFEF" class="root">|</td>
        <td width="76" align="right" bgcolor="#EFEFEF" class="root">Procurement</td>
        <td width="225" align="right" bgcolor="#EFEFEF" class="root"><?php
                    	if($_GET[modul]=='project'){
							$content="Project Handling";
						}
						elseif ($_GET[modul]=='vendor'){
							$content="Vendor";
						}
						elseif ($_GET[modul]=='po'){
							$content="Purchase Order";
						}	
						elseif ($_GET[modul]=='mr'){
							$content="Material Request";
						}
						elseif ($_GET[modul]=='material'){
							$content="Material";
						}
						elseif ($_GET[modul]=='top'){
							$content="Terms of Payment";
						}
						elseif ($_GET[modul]=='shterms'){
							$content="Shipment Terms";
						}
						elseif ($_GET[modul]=='shloc'){
							$content="Shipment Location";
						}
					echo '| '.$content;?>		
			</td>
      </tr>
  ...
  <tr>
    <td valign="top">
        <div class="glossymenu">
            ...
            <a class="menuitem submenu" href="?modul=vendor">Vendor</a>
            <a class="menuitem submenu" href="?modul=po">Purchase Order (PO)</a>
            <a class="menuitem submenu" href="?modul=top">Terms of Payment</a>
            <a class="menuitem submenu" href="?modul=shterms">Shipment Terms</a>
            <a class="menuitem submenu" href="?modul=shloc">Shipment Location</a>
            <a class="menuitem submenu" href="../ppic/allmtrl/viewallmtrl.php" target="_blank">Material</a>
        </div>
    </td>
    <td colspan="2">
    <iframe src="<?php
                    	if($_GET[modul]=='vendor'){
							echo "viewvendor.php";
						}
						elseif ($_GET[modul]=='po'){
							echo "view_headermrsr.php";
						}
						elseif ($_GET[modul]=='project'){
							echo "form_prc.php";
						}
						elseif ($_GET[modul]=='top'){
							echo "viewtermsofpayment.php";
						}
						elseif ($_GET[modul]=='shterms'){
							echo "viewshipmentterms.php";
						}
						elseif ($_GET[modul]=='shloc'){
							echo "viewshipmentloc.php";
						}
