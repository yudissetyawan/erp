    ...
    if(isset($_POST[submit])){
     $direktori = '../proc/upload/vr'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['filevr']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filevr']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filevr']['tmp_name']; //Nama file sementara
