...
<tr>
  <td height="64" colspan="2" rowspan="2"><table width="1200" border="0" align="center">
    <tr>
    ...
    <tr>
      <td align="right" bgcolor="#8db4e3" class="tabel_index" id="font">Outgoing Mail</td>
    ...
    <tr>
      <td colspan="3" align="center" class="General" id="font"><iframe src="<?php
						...
						elseif ($_GET[modul]=='notif'){
							...
							echo "dcc/viewoutmailforhome.php";
						}										
