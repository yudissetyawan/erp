...
$query_am = "SELECT * FROM dms WHERE dms.inisial_pekerjaan = 'MOMam' ORDER BY dms.`date` DESC";
...
<thead>
  <tr class="tabel_header">
    <td colspan="4"><a href="#" onclick="MM_openBrWindow('../addmom.php?data=5','','scrollbars=yes,resizable=yes,width=450,height=300')">Add New</a></td>
  </tr>
  <tr class="tabel_header">
      <td width="34">No.</td>
...
<tbody>
  ...
  <tr class="tabel_body">
    ...
    <td align="center"><?php include "../../dateformat_funct.php";
                		echo functddmmmyyyy($row_am['date']); ?></td>
    <td><a href="../MOM_/uploadmom/<?php echo $row_am['fileupload']; ?>"><?php echo $row_am['keterangan']; ?></a></td>
    <td align="center">&nbsp;</td>
  </tr>
