...
?>
<p><a href="#" onclick="MM_openBrWindow('inputselection.php?data=<?php echo 'WI'; ?>','','width=815,height=500')" id="dialog_link" class="ui-state-default ui-corner-all"><span class="ui-icon ui-icon-plusthick"></span>Add Form</a></p>
<?php } ?>
...
?></td>
      ...
      <td align="center"><?php echo $row_rsdoc['dsop_note']; ?></td>
      <?php
if (($_SESSION['userlvl'] == 'administrator') || ($_SESSION['userlvl'] == 'dcc')) { // || ($_SESSION['userlvl'] == 'branchmanager') 
?>   
      <td align="center">
          <a href="#" onclick="MM_openBrWindow('editForm.php?data=<?php echo $row_rsdoc['doc_no']; ?>','','scrollbars=yes,resizable=yes,width=520,height=480')" title="Edit Data"><img src="images/icedit.png" width="15" height="15"></a>
          &nbsp;&nbsp;
