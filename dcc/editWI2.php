...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE d_sop SET id_dept=%s, doc_no=%s, title=%s, rev=%s, efect_date=%s, retention_time=%s WHERE id=%s",
...
mysql_select_db($database_core, $core);
$query_Recordset3 = sprintf("SELECT * FROM dms WHERE inisial_pekerjaan = 'WI' AND idms = %s", GetSQLValueString($colname_Recordset3, "text"));
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" id="form1">
  <table width="496" align="center" cellpadding="3" cellspacing="3">
    <tr>
    ...
    <tr>
      <td>Title</td>
      <td>:</td>
      <td><textarea name="title" id="title" cols="45" rows="5"><?php echo $row_Recordset2['title']; ?></textarea></td>
    </tr>
    <tr>
