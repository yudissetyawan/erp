...
$query_rsdoc = "SELECT d_sop.id, d_sop.id_dept, d_sop.doc_no, d_sop.rev, d_sop.efect_date, d_sop.title, d_sop.dsop_note, d_sop.interval_review, dms.idms, dms.fileupload, h_department.id, h_department.department, h_department.urutan FROM d_sop, dms, h_department WHERE h_department.id=d_sop.id_dept  AND d_sop.id=dms.idms AND dms.id_departemen=d_sop.id_dept AND dms.inisial_pekerjaan='WI' ORDER BY h_department.urutan ASC, d_sop.doc_no ASC";
...
?>   
      <td align="center">
          <a href="#" onclick="MM_openBrWindow('editWI.php?data=<?php echo $row_rsdoc['idms']; ?>','','scrollbars=yes,resizable=yes,width=520,height=480')" title="Edit Data"><img src="images/icedit.png" width="15" height="15"></a>
          &nbsp;&nbsp;
          <a href="delwi.php?data=<?php echo $row_rsdoc['idms']; ?>" onclick="return confirm('Delete Document No. <?php echo $row_rsdoc['doc_no']; ?> ?')" title="Delete Data"><img src="images/icdel.png" width="15" height="15"></a>
