...
?>
    ...
    if (($_SESSION['userlvl'] == 'administrator') || ($_SESSION['userlvl'] == 'dcc')) { // || ($_SESSION['userlvl'] == 'branchmanager')
        ?>
        <p><a href="#"
              onclick="MM_openBrWindow('inputselection.php?data=<?php echo 'form'; ?>','','width=815,height=500')"
        ...
        do { ?>
            <tr class="tabel_body">
                ...
                if (($_SESSION['userlvl'] == 'administrator') || ($_SESSION['userlvl'] == 'dcc')) { // || ($_SESSION['userlvl'] == 'branchmanager')
                    ...
                    <td align="center">
                        <a href="#"
                           onclick="MM_openBrWindow('editForm.php?data=<?php echo $row_rsdoc['idms']; ?>','','scrollbars=yes,resizable=yes,width=520,height=480')"
                           title="Edit Data">
