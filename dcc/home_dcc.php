...
$MM_authorizedUsers = "administrator,branchmanager,dcc";
...
$MM_restrictGoTo = "/home.php?pesan=Sorry You re not Alowed to access MR/DCC Section";
...
<table width="1270" border="0" align="center">
  ...
  <tr>
    <td align="right" bgcolor="#8db4e3" class="tabel_index" id="font">MR/DCC</td>
        ...
        <table width="400" height="17" border="0" align="left" cellpadding="0" cellspacing="0">
          <tr class="root">
            ...
            <td width="300" align="right" bgcolor="#EFEFEF" class="root"><?php
                            ...
                            } elseif ($_GET[modul]=='inisialnemail'){
                                $content = "Initial and Email";
                            }
                        echo '| '.$content; ?></td>
          </tr>
        </table>
  ...
  <tr>
    <td rowspan="2" valign="top">
    	<div class="glossymenu"> 
              ...
              <a class="menuitem submenu" href="?modul=org_doc">Department Document</a>
              <a class="menuitem submenu" href="?modul=obso"><i>Obsolete Document</i></a>
              <a class="menuitem submenu" href="?modul=xdoc">External Document</a>
              <a class="menuitem submenu" href="?modul=mom">Minute of Meeting (MOM)</a>
              <a class="menuitem submenu" href="?modul=suratkeluar">Outgoing Mail</a>
              <a class="menuitem submenu" href="?modul=inisialnemail">Initial and Email</a>
        </div>
    </td>
    <td colspan="2"></td>
  </tr>
  <tr>
    <td colspan="2" valign="top"><iframe src="<?php
                    	if($_GET[modul]=='suratkeluar'){
							echo "viewoutmail.php";
						}
						elseif ($_GET[modul]=='project'){
							echo "form_dcc.php";
						}
						elseif ($_GET[modul]=='mom'){
							echo "MOM_/viewMOM_dcc.php";
						}
						elseif ($_GET[modul]=='sop'){
							echo "viewSOP.php";
						}
						...
						elseif ($_GET[modul]=='inisialnemail'){
							echo "inisialnemailkaryawan.php";
						}
						else {
							echo"flash/dcc.html";
						}
