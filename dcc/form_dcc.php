...
<table width="1050" border="1" cellpadding="0" cellspacing="0" class="buatform">
  <tr>
    <td width="950"><p align="center"><strong>Please Select Project Code</strong></p>
...
?>
	  ...
	  ?>
        <tr class="tabel_body">
          ...
          <td ><a href="#"><b onClick="MM_openBrWindow('../prj/viewcrfdetail.php?data=<?php echo $sql1[nocrf];?>','crf','width=1200,height=500')"><?=$sql1[jobtitle]?></b></a></td>
          <td align='center'><?php 
		if ($sql1[marketing]==1) 
		{
  ...
  <tr>
    <td width="950">
      ...
      <p>
		...
		$sql=mysql_query("SELECT * FROM a_crf WHERE (a_crf.approval='Y') AND (a_crf.projectcode LIKE '%$cari%') AND (a_crf.file=1) ");
	  $totalseluruhpendaftar=mysql_num_rows($sql);
	  if($totalseluruhpendaftar=='0'){
	 echo "<center><blink>No data available in table </bink></center>";
      ...
      <table width="1034" border="0" cellspacing="1" cellpadding="0">
        <tr class="tabel_header">
          <th colspan="2" > <?
while($sql2=mysql_fetch_array($not)){
	  ?>
          <th colspan="8"><?php echo $sql2[project_code] . " - " . $sql2[customer];?>
            <? } ?>
          </th>
        </tr>
        <tr class="tabel_header">
          <th width="27" class="tabel_header">No.</th>
          <th width='100' class="tabel_header">Production Code</th>
          <th width='429' class="tabel_header">Job Title</th>
          <th width='83' class="tabel_header">&nbsp;</th>
          <th width='61' class="tabel_header">Audit</th>
          <th width='79' class="tabel_header">Audit Eksternal</th>
          <th width='85' class="tabel_header">Management Review</th>
          <th width='71' class="tabel_header">Document</th>
          <th width='87' class="tabel_header">Surat Keluar</th>
        </tr>
        <?
while($sql1=mysql_fetch_array($sql)){
	  ?>
        <tr class="tabel_body">
          ...
          <td><?php echo $sql1[projectcode] . " - " .$sql1[productioncode];?></td>
          <td><a href="work_dcc.php?data=<?php echo $sql1['nocrf'];?>" target="_blank"><b><?=$sql1[jobtitle]?></b></a></td>
