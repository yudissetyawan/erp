...
function setUp(){
    if(!myTable){myTable=document.getElementById("mypagedownup");}
...
<?php
	  ...
	  ?>
      <table width="auto" border="0" cellspacing="1" cellpadding="0"  class="table" id="celebs">
      <thead>
...
<table width="1100" border="0" cellspacing="0" cellpadding="0" class="buatform">
  <tr>
    ...
    <button title="Down" onMouseDown="down();" onMouseUp="down(1);">Dn</button></p>
      <table width="auto" border="0" cellspacing="1" cellpadding="0" id="mypagedownup">
        <thead>
          <tr class="tabel_header">
            <th width='37' >No.</th>
	  ...
	  ?>
          <tr class="tabel_body">
            ...
            <td><?php echo $sql1[projectcode] . " - " .$sql1[productioncode];?></td>
            <td ><a href="upload_work/work_eng.php?data=<?php echo $sql1['nocrf'];?>" target="_blank"><b></b></a><a href="work_engineering.php?data=<?php echo $sql1['nocrf'];?>" target="_blank"><b></b></a><a href="upload_work/work_eng.php?data=<?php echo $sql1['nocrf'];?>" target="_blank"><b><?php echo $sql1[jobtitle] ?></b></a></td>
