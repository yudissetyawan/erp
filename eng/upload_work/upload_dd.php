    ...
    if(isset($_POST[submit10])){
     ...
     $nama_file = $_FILES['filedd']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filedd']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filedd']['tmp_name']; //Nama file sementara
