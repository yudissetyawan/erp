    ...
    if(isset($_POST[submit3])){
     $direktori = '../upload_work/upload/'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['filedr']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filedr']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filedr']['tmp_name']; //Nama file sementara
