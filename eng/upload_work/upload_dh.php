    ...
    if(isset($_POST[submit14])){
     ...
     $nama_file = $_FILES['filedh']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filedh']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filedh']['tmp_name']; //Nama file sementara
