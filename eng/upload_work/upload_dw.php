    ...
    if(isset($_POST[submit0])){
     ...
     $nama_file = $_FILES['filedw']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filedw']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filedw']['tmp_name']; //Nama file sementara
