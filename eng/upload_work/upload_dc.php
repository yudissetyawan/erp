    ...
    if(isset($_POST[submit2])){
     ...
     $nama_file = $_FILES['filedc']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filedc']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filedc']['tmp_name']; //Nama file sementara
