    ...
    if(isset($_POST[submit5])){
     ...
     $nama_file = $_FILES['filedv']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filedv']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filedv']['tmp_name']; //Nama file sementara
