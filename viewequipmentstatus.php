...
<table width="1234" border="0" align="center">
  ...
  <tr>
    <td align="right" bgcolor="#8db4e3" class="tabel_index" id="font">Tools & Equipment Status</td>
  ...
  <tr>
    <td valign="top">
         ...
         <a class="menuitem submenu" href="?modul=swe">Welding Engine</a> 
         </div></td>
    <td colspan="2" valign="top">
    <iframe src="<?php
                    	if($_GET[modul]=='swe'){
							echo "ppic/status_welding_engine.php";
							}
						elseif ($_GET[modul]=='unapproved'){
