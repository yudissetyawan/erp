    ...
    if(isset($_POST[submit3])){
     $direktori = '../mtn/upload/em/'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['fileem']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['fileem']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['fileem']['tmp_name']; //Nama file sementara
