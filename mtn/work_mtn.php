...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO dms (idms, id_departemen, nocrf, inisial_pekerjaan, `date`, fileupload, keterangan) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['idmsct'], "text"),
                       GetSQLValueString($_POST['id_department2'], "text"),
                       GetSQLValueString($_POST['nocrf'], "text"),
                       GetSQLValueString($_POST['inisialct'], "text"),
                       GetSQLValueString($_POST['datect'], "text"),
                       GetSQLValueString($_POST['nama_filect'], "text"),
                       GetSQLValueString($_POST['keteranganct'], "text"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form4")) {
  $insertSQL = sprintf("INSERT INTO dms (idms, id_departemen, nocrf, inisial_pekerjaan, `date`, fileupload, keterangan) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['idmspv'], "text"),
                       GetSQLValueString($_POST['id_department'], "text"),
                       GetSQLValueString($_POST['nocrf'], "text"),
                       GetSQLValueString($_POST['inisialpv'], "text"),
                       GetSQLValueString($_POST['datepv'], "text"),
                       GetSQLValueString($_POST['nama_filepv'], "text"),
                       GetSQLValueString($_POST['keteranganpv'], "text"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form6")) {
  $insertSQL = sprintf("INSERT INTO dms (idms, id_departemen, nocrf, inisial_pekerjaan, `date`, fileupload, keterangan) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['idmsvp3'], "text"),
                       GetSQLValueString($_POST['id_department3'], "text"),
                       GetSQLValueString($_POST['nocrf'], "text"),
                       GetSQLValueString($_POST['inisialem'], "text"),
                       GetSQLValueString($_POST['dateem'], "text"),
                       GetSQLValueString($_POST['nama_fileem'], "text"),
                       GetSQLValueString($_POST['keteranganvp3'], "text"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form6")) {
  $insertSQL = sprintf("INSERT INTO dms (idms, id_departemen, nocrf, inisial_pekerjaan, `date`, fileupload, keterangan) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['idmsvp4'], "text"),
                       ...
                       GetSQLValueString($_POST['keteranganvp4'], "text"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form8")) {
  $updateSQL = sprintf("UPDATE pr_progress_core_scopework SET progress_mtn=%s, idms_mtn=%s WHERE id_progress_header=%s",
...
<table width="1270" border="0" align="center">
  ...
  <tr>
    <td colspan="4" align="right" bgcolor="#8db4e3" class="root" id="font"><table width="600" height="17" border="0" align="left" cellpadding="0" cellspacing="0">
      <tr class="root">
        ...
        <td width="64" align="left" class="root">Maintenance</td>
  ...
  <tr>
    ...
    <?php
        ...
        <ul class='etabs'>
           <li class='tab'><a href="#tabs1-ct">Currative</a></li>
           <li class='tab'><a href="#tabs1-pv">Preventive</a></li>
            <li class='tab'><a href="#tabs1-em">Environemntal</a></li>
            <li class='tab'><a href="#tabs1-pn">Planning</a></li>
        </ul>
         <div class='panel-container'>
          <div id="tabs1-ct">
             <h2>Currative</h2>
             <?php {include "uploadct.php";}?>
             <form method="post" enctype="multipart/form-data" name="form" class="General" id="form">
               Attachment File:
               <input name="filect" type="file" style="cursor:pointer;" />
               <input type="submit" name="submit" value="Upload" />
             </form>
             <form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST">
               <input type="hidden" name="nocrf" id="nocrf" value="<?php echo $row_Recordset1['nocrf']; ?>" />
               <input name="nama_filect" type="hidden" class="hidentext" id="nama_filect" value="<?php echo $nama_file;?>"/>
               <input name="datect" type="hidden" class="hidentext" id="datect" value="<?php echo $tanggal;?>"/>
               <input name="inisialct" type="hidden" class="hidentext" id="inisialct" value="CT"/>
               <input type="hidden" name="id_department2" id="id_department2" value="mtn" />
               <p>
                 <textarea name="keteranganct" id="keteranganct" cols="45" rows="5"></textarea>
                 <input name="idmsct" type="hidden" id="idmsct" value="<?php echo $row_Recordset1['idms']; ?>" />
               </p>
          ...
          <div id="tabs1-pv">
           <h2>Preventive</h2>
           <?php {include "uploadpv.php";}?>
           <form method="post" enctype="multipart/form-data" name="form3" class="General" id="form3">
           Attachment File:
             <input name="filepv" type="file" style="cursor:pointer;" />
             <input type="submit" name="submit2" value="Upload" />
           </form>
           <form action="<?php echo $editFormAction; ?>" id="form4" name="form4" method="POST">
               <input type="hidden" name="nocrf" id="nocrf" value="<?php echo $row_Recordset1['nocrf']; ?>" />
               <input name="nama_filepv" type="hidden" class="hidentext" id="nama_filepv" value="<?php echo $nama_file;?>"/>
               <input name="datepv" type="hidden" class="hidentext" id="datepv" value="<?php echo $tanggal;?>"/>
               <input name="inisialpv" type="hidden" class="hidentext" id="inisialpv" value="PV"/>
               <input type="hidden" name="id_department" id="id_department" value="mtn" />
               <p>
                 <textarea name="keteranganpv" id="keteranganpv" cols="45" rows="5"></textarea>
                 <input name="idmspv" type="hidden" id="idmspv" value="<?php echo $row_Recordset1['idms']; ?>" />
               </p>
          ...
          <div id="tabs1-em">
           <h2>Environmental</h2>
           <?php {include "uploadem.php";}?>
           <form method="post" enctype="multipart/form-data" name="form5" class="General" id="form6">
           Attachment File:
             <input name="fileem" type="file" style="cursor:pointer;" />
             <input type="submit" name="submit3" value="Upload" />
           </form>
           <form action="<?php echo $editFormAction; ?>" id="form6" name="form6" method="POST">
               <input type="hidden" name="nocrf" id="nocrf" value="<?php echo $row_Recordset1['nocrf']; ?>" />
               <input name="nama_fileem" type="hidden" class="hidentext" id="nama_fileem" value="<?php echo $nama_file;?>"/>
               <input name="dateem" type="hidden" class="hidentext" id="dateem" value="<?php echo $tanggal;?>"/>
               <input name="inisialem" type="hidden" class="hidentext" id="inisialem" value="EM"/>
               <input type="hidden" name="id_department3" id="id_department3" value="mtn" />
               <p>
                 <textarea name="keteranganvp3" id="keteranganvp3" cols="45" rows="5"></textarea>
                 <input name="idmsvp3" type="hidden" id="idmsvp3" value="<?php echo $row_Recordset1['idms']; ?>" />
               </p>
          ...
          <div id="tabs1-pn">
           ...
           <form id="form6" name="form6" method="POST" action="<?php echo $editFormAction; ?>">
               <input type="hidden" name="nocrf" id="nocrf" value="<?php echo $row_Recordset1['nocrf']; ?>" />
               <input name="nama_filepn" type="hidden" class="hidentext" id="nama_filepn" value="<?php echo $nama_file;?>"/>
               <input name="datepn" type="hidden" class="hidentext" id="datepn" value="<?php echo $tanggal;?>"/>
               <input name="inisialpn" type="hidden" class="hidentext" id="inisialpn" value="PN"/>
               <input type="hidden" name="id_department4" id="id_department4" value="mtn" />
               <p>
                 <textarea name="keteranganvp4" id="keteranganvp4" cols="45" rows="5"></textarea>
                 <input name="idmsvp4" type="hidden" id="idmsvp4" value="<?php echo $row_Recordset1['idms']; ?>" />
               </p>
               <input type="submit" name="submit6" id="submit2" value="Submit" />
               <input type="hidden" name="MM_insert" value="form6" />
           </form>
