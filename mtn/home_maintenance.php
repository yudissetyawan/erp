...
$MM_authorizedUsers = "administrator,branchmanager,maintenance";
...
$MM_restrictGoTo = "/home.php?pesan=Sorry You re not Alowed to access Maintenance Section";
...
<table width="1270" border="0" align="center">
  ...
  <tr>
    <td align="right" bgcolor="#8db4e3" class="tabel_index" id="font">Maintenance Menu</td>
    <td colspan="2" align="right" bgcolor="#8db4e3" id="font"><table width="216" height="17" border="0" align="left" cellpadding="0" cellspacing="0">
      <tr class="root">
        ...
        <td width="80" align="right" bgcolor="#EFEFEF" class="root">Maintenance</td>
  ...
  <tr>
    <td valign="top">
         ...
         <a class="menuitem submenu" href="../ppic/viewequipmentstatus.php" target="_blank"><i>Tools & Equipment Status</i></a>
    </div></td>
    <td colspan="2">
    <iframe src="<?php
                    	if($_GET[modul]=='project'){
