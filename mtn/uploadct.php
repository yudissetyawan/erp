    ...
    if(isset($_POST[submit])){
     $direktori = '../mtn/upload/ct/'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['filect']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filect']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filect']['tmp_name']; //Nama file sementara
