    ...
    if(isset($_POST[submit4])){
     $direktori = '../mtn/upload/pn/'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['filepn']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filepn']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filepn']['tmp_name']; //Nama file sementara
