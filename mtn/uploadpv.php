    ...
    if(isset($_POST[submit2])){
     $direktori = '../mtn/upload/pv/'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['filepv']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filepv']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filepv']['tmp_name']; //Nama file sementara
