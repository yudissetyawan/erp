...
$MM_authorizedUsers = "administrator,branchmanager";
...
$MM_restrictGoTo = "/home.php?pesan=Sorry You re not Alowed to access Top Management Section";
...
<title>Home Top Management</title>
...
<table width="1183" border="0" align="center">
  <tr>
    ...
    <td width="426" align="right" valign="top">
    <table width="400" border="0" align="right" cellpadding="1" cellspacing="1">
      <tr class="demoHeaders">
        ...
        <td align="right" width="65" class="demoHeaders"><a href="../logout.php">Logout</a></td>
        <td align="right">|</td>
      </tr>
    </table>
    </td>
  ...
  <tr>
    <td align="right" bgcolor="#8db4e3" class="tabel_index" id="font">Top Management Menu</td>
    <td colspan="2" valign="middle" align="right" bgcolor="#8db4e3" id="font">
    <table height="17" border="0" align="left" cellpadding="0" cellspacing="0">
      <tr class="tabel_index">
        <td width="49" bgcolor="#EFEFEF" class="root"><a href="../home.php">Home</a></td>
        <td width="6" align="right" bgcolor="#EFEFEF" class="root">|</td>
        <td width="120" align="right" bgcolor="#EFEFEF" class="root">Top Management</td>
        <td align="right" bgcolor="#EFEFEF" class="root"><?php
                    	if($_GET[modul]=='approval'){
							$content="Approval CRF   |";
							}
						elseif ($_GET[modul]=='grafik_ceb'){
							$content="Cont Expend & Balance   |";
							}
						elseif ($_GET[modul]=='grafik_bc'){
							$content="Budget & Cost   |";
							}
  ...
  <tr>
    ...
    <div class="glossymenu">
        <a class="menuitem submenu" href="?modul=approval" onclick="<? echo "$n" ?>">Approval CRF </a>
 		<!--<a class="menuitem submenu" href="?modul=grafik_ceb">Cont. Expend & Balance</a> -->
        <a class="menuitem submenu" href="?modul=grafik_bc">Budget & Cost</a>
    </div></td>
    <td colspan="2"></td>
  </tr>
  <tr>
    <td colspan="2" valign="top"><iframe src="<?php
						...
						elseif ($_GET[modul]=='grafik_bc'){
							echo "header_grafik.php";
						}
						elseif ($_GET[modul]=='unapproved'){
							echo "unapproved_crf.php";
						}
						elseif ($_GET[modul]=='notif'){
							echo "../prj/bacanotif.php?data=$usrid";
						}
						elseif ($_GET[modul]=='approval'){
							echo "form_tm.php";}
						else{
							echo "flash/tm.html";
							}
							
					?>" frameborder="0" width="1075" height="575"> </iframe></td>
  </tr>
  <tr>
    <td colspan="3" id="font" align="center"></td>
  </tr>
  <tr>
    <td width="174">&nbsp;</td>
    <td width="569" class="pesan"><?php echo $_GET['pesan']; ?></td>
