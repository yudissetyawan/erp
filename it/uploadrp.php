    ...
    if(isset($_POST[submit])){
     $direktori = '../it/upload/rp/'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['filerp']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filerp']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filerp']['tmp_name']; //Nama file sementara
