    ...
    if(isset($_POST[submit2])){
     $direktori = '../it/upload/sd/'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['filesd']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filesd']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filesd']['tmp_name']; //Nama file sementara
