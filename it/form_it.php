  ...
  <tr>
    <td width="950">
      ...
      <p>
		...
		$sql=mysql_query("SELECT * FROM a_crf WHERE (a_crf.approval='Y') AND (a_crf.projectcode LIKE '%$cari%') AND (a_crf.it=1) ORDER BY nocrf ASC ");
	  $totalseluruhpendaftar=mysql_num_rows($sql);
	  if($totalseluruhpendaftar=='0'){
	 echo "<center><blink>No data available in table </bink></center>";
	}
	  ...
	  ?>
      <table width="1222" border="0" cellspacing="1" cellpadding="0">
        <tr class="tabel_header">
          <th colspan="2" > <?
while($sql2=mysql_fetch_array($not)){
	  ?>
        ...
        <tr class="tabel_header">
          <th width="29" class="tabel_header">No.</th>
          <th width='101' class="tabel_header">No. CRF</th>
          <th width='534' class="tabel_header">Job Title</th>
          <th width='97' class="tabel_header">&nbsp;</th>
          <th width='144' class="tabel_header">Request IT Peripheral</th>
          <th width='88' class="tabel_header">Service Desk</th>
          <th width='129' class="tabel_header">Monitoring System</th>
          <th width='91' class="tabel_header">Assets System</th>
        </tr>
        <?
while($sql1=mysql_fetch_array($sql)){
	  ?>
        <tr class="tabel_body">
          ...
          <td><?php echo $sql1[projectcode] . " - " .$sql1[productioncode];?></td>
          <td ><a href="work_it.php?data=<?php echo $sql1['nocrf'];?>" target="_blank"><b><?php echo $sql1[jobtitle];?></b></a></td>
