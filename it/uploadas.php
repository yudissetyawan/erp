    ...
    if(isset($_POST[submit4])){
     $direktori = '../it/upload/as/'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['fileas']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['fileas']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['fileas']['tmp_name']; //Nama file sementara
