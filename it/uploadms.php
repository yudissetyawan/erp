    ...
    if(isset($_POST[submit3])){
     $direktori = '../it/upload/ms/'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['filems']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filems']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filems']['tmp_name']; //Nama file sementara
