...
$MM_authorizedUsers = "administrator,branchmanager,it";
...
$MM_restrictGoTo = "/home.php?pesan=You are being Loged this section Strictly Prohibited Access";
...
<table width="1270" border="0" align="center">
  ...
  <tr>
    <td align="right" bgcolor="#8db4e3" class="tabel_index" id="font">IT Menu</td>
    <td colspan="2" align="right" bgcolor="#8db4e3" id="font"><table width="250" height="17" border="0" align="left" cellpadding="0" cellspacing="0">
      <tr class="root">
        <td width="40" bgcolor="#EFEFEF" class="root"><a href="../home.php">Home</a></td>
        <td width="10" bgcolor="#EFEFEF" class="root">|</td>
        <td width="30" bgcolor="#EFEFEF" class="root">IT</td>
        <td width="170" bgcolor="#EFEFEF" class="root"><?php
                    	if($_GET[modul]=='project'){
							$content="Project Handling";
						}	
						else if($_GET[modul]=='manual'){
							$content="User Manual of Bi-SmartS";
						}
						elseif ($_GET[modul]=='ntfset'){
							$content="Notification Setting";
						}
						elseif ($_GET[modul]=='bkknews'){
							$content="Bukaka News";
						}
  ...
  <tr>
    <td valign="top">
		...
		<?php if ($_SESSION['userlvl'] == 'administrator') { ?>	
            <a class="menuitem submenu" href="?modul=ntfset"><i>Notification Setting</i></a>
			<a class="menuitem submenu" href="?modul=manual"><i>User Manual of Bi-SmartS</i></a>
			<a class="menuitem submenu" href="?modul=bkknews">Bukaka News</a>
            <a class="menuitem submenu" href="?modul=contact_us">Contact Us</a>
        <?php } ?>
        <a class="menuitem submenu" href="?modul=assetit">Data Asset IT</a>
		</div>
    </td>
    <td colspan="2"><iframe src="<?php
						...
						elseif ($_GET[modul]=='manual'){
							echo "listofmanual.php";
						}
						elseif ($_GET[modul]=='bkknews'){
							echo "news_view.php";
						}
						elseif ($_GET[modul]=='contact_us'){
							echo "contactus_viewheader.php";
						}
						elseif ($_GET[modul]=='unapproved'){
						...
						elseif ($_GET[modul]=='assetit'){
							echo "assetit_view_header.php";
						}
						else {
							echo"flash/it.html";
						}
					?>" frameborder="0" width="1075" height="550">
                    </iframe>
		</td>
  </tr>
  <tr>
