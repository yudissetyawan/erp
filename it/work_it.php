...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO dms (idms, id_departemen, nocrf, inisial_pekerjaan, `date`, fileupload, keterangan) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['idmsrp'], "text"),
                       GetSQLValueString($_POST['id_department2'], "text"),
                       GetSQLValueString($_POST['nocrf'], "text"),
                       GetSQLValueString($_POST['inisialrp'], "text"),
                       GetSQLValueString($_POST['daterp'], "text"),
                       GetSQLValueString($_POST['nama_filerp'], "text"),
                       GetSQLValueString($_POST['keteranganrp'], "text"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form4")) {
  $insertSQL = sprintf("INSERT INTO dms (idms, id_departemen, nocrf, inisial_pekerjaan, `date`, fileupload, keterangan) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['idmssd'], "text"),
                       GetSQLValueString($_POST['id_department'], "text"),
                       GetSQLValueString($_POST['nocrf'], "text"),
                       GetSQLValueString($_POST['inisialsd'], "text"),
                       GetSQLValueString($_POST['datesd'], "text"),
                       GetSQLValueString($_POST['nama_filesd'], "text"),
                       GetSQLValueString($_POST['keterangansd'], "text"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form6")) {
  $insertSQL = sprintf("INSERT INTO dms (idms, id_departemen, nocrf, inisial_pekerjaan, `date`, fileupload, keterangan) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['idmsms'], "text"),
                       GetSQLValueString($_POST['id_department3'], "text"),
                       GetSQLValueString($_POST['nocrf'], "text"),
                       GetSQLValueString($_POST['inisialms'], "text"),
                       GetSQLValueString($_POST['datems'], "text"),
                       GetSQLValueString($_POST['nama_filems'], "text"),
                       GetSQLValueString($_POST['keteranganms'], "text"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form8")) {
  $updateSQL = sprintf("UPDATE pr_progress_core_scopework SET progress_it=%s, idms_it=%s WHERE id_progress_header=%s",
  ...
  <tr>
    <td colspan="4" align="right" bgcolor="#8db4e3" class="root" id="font"><table width="600" height="17" border="0" align="left" cellpadding="0" cellspacing="0">
      <tr class="root">
        ...
        <td width="64" align="left" class="root">IT</td>
  ...
  <tr>
    ...
    <?php
    	...
    	<div id="tab-container" class='tab-container'>
         <ul class='etabs'>
           <li class='tab'><a href="#tabs1-rp">Request IT Peripheral</a></li>
           <li class='tab'><a href="#tabs1-sd">Services Desk</a></li>
            <li class='tab'><a href="#tabs1-ms">Monitoring System</a></li>
            <li class='tab'><a href="#tabs1-as">Assets System</a></li>
         </ul>
           
         <div class='panel-container'>
          <div id="tabs1-rp">
             <h2>Request IT Peripheral</h2>
             <?php {include "uploadrp.php";}?>
             <form method="post" enctype="multipart/form-data" name="form" class="General" id="form">
               Attachment File:
               <input name="filerp" type="file" style="cursor:pointer;" />
               <input type="submit" name="submit" value="Upload" />
             </form>
             <form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST">
               <input type="hidden" name="nocrf" id="nocrf" value="<?php echo $row_Recordset1['nocrf']; ?>" />
               <input name="nama_filerp" type="hidden" class="hidentext" id="nama_filerp" value="<?php echo $nama_file;?>"/>
               <input name="daterp" type="hidden" class="hidentext" id="daterp" value="<?php echo $tanggal;?>"/>
               <input name="inisialrp" type="hidden" class="hidentext" id="inisialrp" value="RP"/>
               <input type="hidden" name="id_department2" id="id_department2" value="it" />
               <p>
                 <textarea name="keteranganrp" id="keteranganrp" cols="45" rows="5"></textarea>
                 <input name="idmsrp" type="hidden" id="idmsrp" value="<?php echo $row_Recordset1['idms']; ?>" />
               </p>
        ...
        <input type="hidden" name="MM_insert" value="form1" />
          ...
          <div id="tabs1-sd">
           <h2>Services Desk</h2>
           <?php {include "uploadsd.php";}?>
           <form method="post" enctype="multipart/form-data" name="form3" class="General" id="form3">
           Attachment File:
             <input name="filesd" type="file" style="cursor:pointer;" />
             <input type="submit" name="submit2" value="Upload" />
           </form>
           <form action="<?php echo $editFormAction; ?>" id="form4" name="form4" method="POST">
               <input type="hidden" name="nocrf" id="nocrf" value="<?php echo $row_recordset1['nocrf'];?>" />
               <input name="nama_filesd" type="hidden" class="hidentext" id="nama_filesd" value="<?php echo $nama_file;?>"/>
               <input name="datesd" type="hidden" class="hidentext" id="datesd" value="<?php echo $tanggal;?>"/>
               <input name="inisialsd" type="hidden" class="hidentext" id="inisialsd" value="SD"/>
               <input type="hidden" name="id_department" id="id_department" value="it" />
               <p>
                 <textarea name="keterangansd" id="keterangansd" cols="45" rows="5"></textarea>
                 <input name="idmssd" type="hidden" id="idmssd" value="<?php echo $row_Recordset1['idms']; ?>" />
               </p>
        ...
        <input type="hidden" name="MM_insert" value="form4" />
          ...
          <div id="tabs1-ms">
           ...
           <?php {include "uploadms.php";}?>
           <form method="post" enctype="multipart/form-data" name="form5" class="General" id="form6">
           Attachment File:
             <input name="filems" type="file" style="cursor:pointer;" />
             <input type="submit" name="submit3" value="Upload" />
           </form>
           <form action="<?php echo $editFormAction; ?>" id="form6" name="form6" method="POST">
               <input type="hidden" name="nocrf" id="nocrf" value="<?php echo $row_recordset1['nocrf'];?>" />
               <input name="nama_filems" type="hidden" class="hidentext" id="nama_filems" value="<?php echo $nama_file;?>"/>
               <input name="datems" type="hidden" class="hidentext" id="datems" value="<?php echo $tanggal;?>"/>
               <input name="inisialms" type="hidden" class="hidentext" id="inisialms" value="MS"/>
               <input type="hidden" name="id_department3" id="id_department3" value="it" />
               <p>
                 <textarea name="keteranganms" id="keteranganms" cols="45" rows="5"></textarea>
                 <input name="idmsms" type="hidden" id="idmsms" value="<?php echo $row_Recordset1['idms']; ?>" />
               </p>
        <input type="submit" name="submit6" id="submit2" value="Submit" />
        <input type="hidden" name="MM_insert" value="form6" />
          ...
          <div id="tabs1-as">
           ...
           <form id="form6" name="form6" method="POST" action="<?php echo $editFormAction; ?>">
               <input type="hidden" name="nocrf" id="nocrf" value="<?php echo $row_recordset1['nocrf'];?>" />
               <input name="nama_fileas" type="hidden" class="hidentext" id="nama_fileas" value="<?php echo $nama_file;?>"/>
               <input name="dateas" type="hidden" class="hidentext" id="dateas" value="<?php echo $tanggal;?>"/>
               <input name="inisialas" type="hidden" class="hidentext" id="inisialas" value="AS"/>
               <input type="hidden" name="id_department4" id="id_department4" value="it" />
               <p>
