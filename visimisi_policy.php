  ...
  <tr>
    <td rowspan="2" valign="top">  <div class="glossymenu"> 
              ...
              <a class="menuitem submenu" href="?modul=hsepolice">HSE Policy</a>
                 ...
                 <a class="menuitem submenu" href="?modul=driving">Driving Policy</a></div></td>
    <td colspan="2"></td>
  </tr>
  <tr>
    <td colspan="2" valign="top"><iframe align="middle" src="<?php
                    	if($_GET[modul]=='visimisi'){
							echo "image/Visi_Misi.pdf";
							}
						elseif ($_GET[modul]=='qlypolice'){
							echo "image/Quality_Policy.pdf";
							}
						elseif ($_GET[modul]=='hsepolice'){
							echo "image/HSE_Policy.pdf";
							}
						elseif ($_GET[modul]=='drugs'){
							echo "image/Drugs_Policy.pdf";
							}
						elseif ($_GET[modul]=='driving'){
							echo "image/Driving_Policy.pdf";
							}
