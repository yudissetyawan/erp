    ...
    if(isset($_POST[submit])){
     $direktori = '../qly/upload/ncr/'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['filencr']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filencr']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filencr']['tmp_name']; //Nama file sementara
