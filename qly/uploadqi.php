    ...
    if(isset($_POST[submit3])){
     $direktori = '../qly/upload/qi/'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['fileqp']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['fileqp']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['fileqp']['tmp_name']; //Nama file sementara
