...
<table width="1270" border="0" align="center">
  <tr>
    <td width="1256" align="left" class="General" id="font"><div id="TabbedPanels1" class="TabbedPanels">
      <ul class="TabbedPanelsTabGroup">
        <li class="TabbedPanelsTab" tabindex="0"><b>Complaint</b></li>
        <li class="TabbedPanelsTab" tabindex="0"><b>Corrective & Preventive Action Request (CPAR)</b></li>
      </ul>
      <div class="TabbedPanelsContentGroup">
        <div class="TabbedPanelsContent"><iframe style="border:thin" width="1200" height="405" src="cpar_complaint_header.php"></iframe></div>
        <div class="TabbedPanelsContent"><iframe style="border:thin" width="1200" height="405" src="cpar_header.php"></iframe></div>
      </div>
<p>&nbsp;</p>
    </div></td>
  </tr>
