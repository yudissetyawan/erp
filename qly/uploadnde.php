    ...
    if(isset($_POST[submit7])){
     $direktori = '../qly/upload/nde/'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['filende']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filende']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filende']['tmp_name']; //Nama file sementara
