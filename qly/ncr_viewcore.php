...
<form method="POST" name="form1" class="General" id="form1">
  <table width="1000" border="1" style="border-collapse:collapse" cellpadding="2" cellspacing="3">
    ...
    <tr>
      <td width="175" valign="top">Non Conformance Report :</td>
      <td colspan="3"><textarea readonly="readonly" name="ncr" id="ncr2" cols="50" rows="3" style="border:thin"><?php echo $row_q_ncr['title_ncr']; ?></textarea></td>
      <td valign="top">NCR No. :</td>
      <td valign="top"><?php echo $row_q_ncr['no_ncr']; ?></td>
    </tr>
    <tr>
      <td>Department / Supplier :</td>
      <td colspan="3"><label for="dept2"><?php echo $row_h_dept['department']; ?></label></td>
