    ...
    if(isset($_POST[submit2])){
     ...
     $nama_file = $_FILES['filepr']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filepr']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filepr']['tmp_name']; //Nama file sementara
