    ...
    if(isset($_POST[submit3])){
     $direktori = '../qly/upload/cp/'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['filecp']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filecp']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filecp']['tmp_name']; //Nama file sementara
