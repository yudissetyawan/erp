    ...
    if(isset($_POST[submit4])){
     $direktori = '../qly/upload/qd/'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['fileqd']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['fileqd']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['fileqd']['tmp_name']; //Nama file sementara
