    ...
    if(isset($_POST[submit])){
     $direktori = '../qly/upload/cb/'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['filecb']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filecb']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filecb']['tmp_name']; //Nama file sementara
