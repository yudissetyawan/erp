...
<p><a href="#" onclick="MM_openBrWindow('xdoc_input.php?data=<?php echo $row_rsxdoccatg1['id']; ?>','','width=650,height=450')" id="dialog_link" class="ui-state-default ui-corner-all"><span class="ui-icon ui-icon-plusthick"></span>Add Document</a></p>
<?php } ?>
  ...
  <tbody> 
    ...
    do { ?>
		<tr class="tabel_body">
		  ...
		  <td><a href=../dcc/upload/<?php echo $row_rsxdoc['fileupload']; ?> target="_blank"><?php echo $row_rsxdoc['title']; ?></a></td>
		...
		<?php if ($_SESSION['userlvl'] == 'administrator') { // || ($_SESSION['userlvl'] == 'branchmanager')) { ?>
          <td align="center">
          	<a href="xdoc_del.php?data=<?php echo $row_rsxdoc['id']; ?>" onclick="return confirm('Delete Document No. <?php echo $row_rsxdoc['doc_no']; ?> ?')">Edit</a>
          |
          	<a href="xdoc_del.php?data=<?php echo $row_rsxdoc['id']; ?>" onclick="return confirm('Delete Document No. <?php echo $row_rsxdoc['doc_no']; ?> ?')">Delete</a>
          </td>
       	<?php } ?>
