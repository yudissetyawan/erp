...
<table width="1000" border="1" cellspacing="0" cellpadding="0" class="buatform">
  ...
  <tr>
    <td width="1017"><p align="center"><strong>Project Code</strong></p>
  ...
  <tr>
    <td width="950">
      ...
      <p>
		...
		$sql=mysql_query("SELECT * FROM a_crf WHERE (a_crf.approval='Y') AND (a_crf.projectcode LIKE '%$cari%') AND (a_crf.hse=1) ORDER BY nocrf ASC ");
	  $totalseluruhpendaftar=mysql_num_rows($sql);
	  if($totalseluruhpendaftar=='0'){
	 echo "<center><blink>No data available in table </bink></center>";
	}
	  ...
	  ?>
      <table width="1136" border="0" cellspacing="1" cellpadding="0">
        <tr class="tabel_header">
          <th colspan="2" >
     <?
while($sql2=mysql_fetch_array($not)){
	  ?>
          <th colspan="5"><?php echo $sql2[project_code] . " - " . $sql2[customer];?>            <? } ?></th>
        </tr>
        <tr class="tabel_header">
          <th width="31" class="tabel_header">No.</th>
          <th width='110' class="tabel_header">No. CRF</th>
          <th width='647' class="tabel_header">Job Title</th>
          <th width='126' class="tabel_header">&nbsp;</th>
          <th width='126' class="tabel_header">Hazard Identification</th>
          <th width='126' class="tabel_header">JSA</th>
          <th width='115' class="tabel_header">Work Permit</th>
        </tr>
        <?
while($sql1=mysql_fetch_array($sql)){
	  ?>
        <tr class="tabel_body">
          ...
          <td><?php echo $sql1[projectcode] . " - " .$sql1[productioncode];?></td>
          <td ><a href="work_hse.php?data=<?php echo $sql1['nocrf']; ?>" target="_blank"><b><?php echo $sql1[jobtitle];?></b></a></td>
          <td align="center">&nbsp;</td>
          <td align="center" ><a href="#" onClick="MM_openBrWindow('hazard_identification.php?data=<?php echo $sql1['nocrf']; ?>','','scrollbars=yes,resizable=yes,width=700,height=500')">Hazard Identification</a></td>
          <td align="center"><a href="#" onClick="MM_openBrWindow('jsa.php','','scrollbars=yes,resizable=yes,width=700,height=500')">JSA</a></td>
          <td align="center"><a href="#" onClick="MM_openBrWindow('work_permit','','scrollbars=yes,resizable=yes,width=700,height=500')">Work Permit</a></td>
        </tr>
        <?
		}
		?>
