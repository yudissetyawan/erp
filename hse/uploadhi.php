    ...
    if(isset($_POST[submit])){
     $direktori = '../hse/upload/hi/'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['filehi']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filehi']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filehi']['tmp_name']; //Nama file sementara
