    ...
    if(isset($_POST[submit2])){
     $direktori = '../hse/upload/sa/'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['filesa']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filesa']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filesa']['tmp_name']; //Nama file sementara
