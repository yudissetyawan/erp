    ...
    if(isset($_POST[submit3])){
     $direktori = '../hse/upload/wp/'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['filewp']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filewp']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filewp']['tmp_name']; //Nama file sementara
