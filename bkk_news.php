...
<table width="1200" border="0" align="center">
  ...
  <tr>
    <td align="right" bgcolor="#8db4e3" class="tabel_index" id="font">Bukaka News</td>
  ...
  <tr>
    <td colspan="3" align="center" class="General" id="font"><iframe src="<?php
						...
						elseif ($_GET[modul]=='notif'){
							...
							echo "it/news_view.php";
						}										
					?>" width="1200" height="550" style="border:thin"></iframe></td>
  </tr>
  <tr>
    <td width="174">&nbsp;</td>
