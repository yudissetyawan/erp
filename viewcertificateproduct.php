...
<table width="1234" border="0" align="center">
  ...
  <tr>
    ...
    <td colspan="2" align="right" bgcolor="#8db4e3" id="font"><table width="243" height="17" border="0" align="left" cellpadding="0" cellspacing="0">
      <tr class="root">
        <td width="80" class="root"><a href="../home.php">Home </a></td>
<td width="163" class="root"><strong><strong>
<?php
                    	if ($_GET[modul]=='sb'){
							$content = "Sand Basket";
						}
  ...
  <tr>
    <td valign="top">
         ...
         <a class="menuitem submenu" href="?modul=sp">Scaffolding And Plate</a>
    ...
    <iframe src="<?php
                    	if($_GET[modul]=='sb'){
							echo "ppic/viewcertificateproductSB.php";
						}
						elseif ($_GET[modul]=='sp'){
							echo "ppic/viewcertificateproductSP.php";
						}
						elseif ($_GET[modul]=='sk'){
							echo "ppic/viewcertificateproductSK.php";
						}
						elseif ($_GET[modul]=='cbr'){
							echo "ppic/viewcertificateproductCBR.php";
						}
						elseif ($_GET[modul]=='sling'){
							echo "ppic/viewcertificateproductSL.php";
						}
						elseif ($_GET[modul]=='bs'){
							echo "ppic/viewcertificateproductBS.php";
						}
						elseif ($_GET[modul]=='ws'){
							echo "ppic/viewcertificateproductWS.php";
						}
						elseif ($_GET[modul]=='cb'){
							echo "ppic/viewcertificateproductCB.php";
						}
						elseif ($_GET[modul]=='bc'){
							echo "ppic/viewcertificateproductBC.php";
						}
						elseif ($_GET[modul]=='unapproved'){
