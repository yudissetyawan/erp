...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateSQL = sprintf("UPDATE p_certificate_product SET id_category_product=%s, name_of_equipment=%s, tag_serial_number=%s, length_m=%s, SWL_tons=%s, diameter_inch=%s, inspection_date=%s, expired_date=%s, location=%s, issued_by=%s, exist_date=%s, issued_user=%s, no_certificate=%s, status=%s WHERE id_certificate=%s",
                       ...
                       GetSQLValueString($_POST['length_m'], "double"),
                       GetSQLValueString($_POST['SWL_tons'], "double"),
                       GetSQLValueString($_POST['diameter_inch'], "double"),
  ...
  $updateGoTo = "viewcertificateproductWS.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_core, $core);
$query_Recordset1 = sprintf("SELECT p_certificate_product.*, dms.idms, dms.fileupload, dms.id, dms.id_departemen FROM p_certificate_product, dms WHERE p_certificate_product.id_category_product='8'  AND dms.keterangan=p_certificate_product.name_of_equipment AND dms.id_departemen = 'QC'  AND dms.idms=p_certificate_product.id_certificate AND p_certificate_product.id_certificate = %s", GetSQLValueString($colname_Recordset1, "int"));
...
<title>Input Certificate of Webbing Sling</title>
</head>
...
<label style="font-weight:bold" <?php echo $vhidden; ?> >Edit Certificate of Webbing Sling</label>
<br /><br />
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" id="form1">
  <table>
    ...
    <tr valign="middle">
      ...
      <td align="left">:</td>
      <td><input type="text" name="length_m" value="<?php echo $row_Recordset1['length_m']; ?>" size="8" <?php echo $vdisabled; ?> /></td>
    </tr>
    <tr valign="middle">
      <td align="left">SWL (tons)</td>
      <td align="left">:</td>
      <td><input type="text" name="SWL_tons" value="<?php echo $row_Recordset1['SWL_tons']; ?>" size="8" <?php echo $vdisabled; ?> /></td>
    </tr>
    <tr valign="middle">
      <td align="left">Diameter (inch)</td>
      <td align="left">:</td>
      <td><input type="text" name="diameter_inch" value="<?php echo $row_Recordset1['diameter_inch']; ?>" size="8" <?php echo $vdisabled; ?> /></td>
    </tr>
    <tr valign="middle">
      <td colspan="3" align="left">&nbsp;</td>
    </tr>
    ...
    <tr valign="middle">
      ...
      <td align="left">:</td>
      <td><input type="text" name="issued_by" value="<?php echo $row_Recordset1['issued_by']; ?>" size="40" <?php echo $vdisabled; ?> /></td>
    </tr>
    <tr valign="middle">
      <td align="left">Location</td>
      <td align="left">:</td>
      <td><input type="text" name="location" value="<?php echo $row_Recordset1['location']; ?>" size="40" <?php echo $vdisabled; ?> /></td>
    </tr>
    <tr valign="middle">
