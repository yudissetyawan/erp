...
<title>Lifting EQP. Certification</title>
...
<table width="1234" border="0" align="center">
  ...
  <tr>
    <td align="right" bgcolor="#8db4e3" class="tabel_index" id="font">Lifting EQP. Certification</td>
    <td colspan="2" align="right" bgcolor="#8db4e3" id="font"><table width="243" height="17" border="0" align="left" cellpadding="0" cellspacing="0">
      <tr class="root">
        <td width="68" bgcolor="#EFEFEF" class="root"><a href="../home.php">Home</a></td>
        <td width="10" bgcolor="#EFEFEF" class="root">|</td>
        <td width="165" bgcolor="#EFEFEF" class="root"><strong><?php
                    	if($_GET[modul]=='swe'){
							$content="Status Welding Engine";
							}
						elseif ($_GET[modul]=='sb'){
							$content = "Sand Basket";
							}
						elseif ($_GET[modul]=='sp'){
							$content = "Scaffolding and Plate";
							}
						elseif ($_GET[modul]=='sk'){
							$content="SKID";
							}
						elseif ($_GET[modul]=='cbr'){
							$content="Cylinder Bottle Rack";
						}
						elseif ($_GET[modul]=='sling'){
							$content="SLING";
						}
						elseif ($_GET[modul]=='bs'){
							$content="Bow Shackles";
							}
						elseif ($_GET[modul]=='ws'){
							$content="Webbing Sling";
							}
						elseif ($_GET[modul]=='cb'){
							$content="Chain Block";
							}
						elseif ($_GET[modul]=='bc'){
							$content="Beam Clamp";
							}
  ...
  <tr>
    <td valign="top">
         ...
         <a class="menuitem submenu" href="?modul=sb">Sand Basket</a>
         <a class="menuitem submenu" href="?modul=sp">Scafolding And Plate</a>
         <a class="menuitem submenu" href="?modul=sk">SKID</a>
         <a class="menuitem submenu" href="?modul=cbr">Cylinder Bottle Rack</a>
         <a class="menuitem submenu" href="?modul=sling">SLING</a>
      	 <a class="menuitem submenu" href="?modul=bs">Bow Shackles</a>
         <a class="menuitem submenu" href="?modul=ws">Webbing Sling</a>
         <a class="menuitem submenu" href="?modul=cb">Chain Block</a>
         <a class="menuitem submenu" href="?modul=bc">Beam Clamp</a>
         </div></td>
    <td colspan="2" valign="top">
    <iframe src="<?php
                    	if ($_GET[modul]=='sb'){
							echo "viewcertificateproductSB.php";
							}
						elseif ($_GET[modul]=='sp'){
							echo "viewcertificateproductSP.php";
							}
						elseif ($_GET[modul]=='sk'){
							echo "viewcertificateproductSK.php";
							}
						elseif ($_GET[modul]=='cbr'){
							echo "viewcertificateproductCBR.php";
						}
						elseif ($_GET[modul]=='sling'){
							echo "viewcertificateproductSL.php";
						}
						elseif ($_GET[modul]=='bs'){
							echo "viewcertificateproductBS.php";
							}
						elseif ($_GET[modul]=='ws'){
							echo "viewcertificateproductWS.php";
							}
						elseif ($_GET[modul]=='cb'){
							echo "viewcertificateproductCB.php";
							}
						elseif ($_GET[modul]=='bc'){
							echo "viewcertificateproductBC.php";
							}
						elseif ($_GET[modul]=='unapproved'){
