...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateSQL = sprintf("UPDATE p_bbk_header SET no_bbk=%s, id_bpb=%s, tanggal=%s, diketahui_by=%s, diserahkan_by=%s, diterima_by=%s WHERE id=%s",
  ...
  $updateGoTo = "bbk/view_bbk_header.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<h3>Edit Header BBK</h3>

<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table class="General" width="500">
    <tr>
      <td>No. BBK</td>
      <td>:</td>
      <td><input type="text" name="no_bbk" value="<?php echo htmlentities($row_p_bbk_header['no_bbk'], ENT_COMPAT, 'utf-8'); ?>" size="22" readonly="readonly" style="border:thin" /></td>
    </tr>
	...
	do {  
	?>
        <option value="<?php echo $row_bpb['id']?>" <?php if ($row_bpb['id'] == $row_p_bbk_header['id_bpb']) { ?> selected="selected" <?php } ?>><?php echo $row_bpb['bpb_no']?></option>
        <?php
    ...
    <tr>
      <td>Tanggal</td>
      <td>:</td>
      <td><input type="text" name="tanggal" value="<?php require_once "../dateformat_funct.php"; echo functddmmmyyyy($row_p_bbk_header['tanggal']); ?>" size="15" id="tanggal8" /></td>
    </tr>
	...
	do {  
	?>
        <option value="<?php echo $row_diketahui['id']?>" <?php if ($row_diketahui['id'] == $row_p_bbk_header['diketahui_by']) { ?> selected="selected" <?php } ?>><?php echo $row_diketahui['firstname']?> <?php echo $row_diketahui['midlename']; ?> <?php echo $row_diketahui['lastname']; ?></option>
        <?php
	...
	do {  
	?>
        <option value="<?php echo $row_diserahkan['id']?>" <?php if ($row_diserahkan['id'] == $row_p_bbk_header['diserahkan_by']) { ?> selected="selected" <?php } ?>><?php echo $row_diserahkan['firstname']?> <?php echo $row_diserahkan['midlename']; ?> <?php echo $row_diserahkan['lastname']; ?></option>
        <?php
	...
	do {  
	?>
        <option value="<?php echo $row_diterima['id']?>" <?php if ($row_diterima['id'] == $row_p_bbk_header['diterima_by']) { ?> selected="selected" <?php } ?>><?php echo $row_diterima['firstname']?> <?php echo $row_diterima['midlename']; ?> <?php echo $row_diterima['lastname']; ?></option>
        <?php
  ...
  <input type="hidden" name="id" value="<?php echo $row_p_bbk_header['id']; ?>" />
  <input type="hidden" name="MM_update" value="form1" />
</form>
<p>&nbsp;</p>
</body>
