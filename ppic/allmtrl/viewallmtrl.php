...
$query_rsmcat = "SELECT * FROM m_category";
...
<table width="1234" border="0" align="center">
  ...
  <tr>
    <td align="right" bgcolor="#8db4e3" class="tabel_index" id="font">Material</td>
    <td colspan="2" align="right" bgcolor="#8db4e3" id="font">
        <table width="600" height="17" border="0" align="left" cellpadding="0" cellspacing="0">
          <tr class="root">
            <td width="70" bgcolor="#EFEFEF" class="root"><a href="../../home.php">Home</a></td>
            <td width="10" bgcolor="#EFEFEF" class="root">|</td>
            <td width="520" bgcolor="#EFEFEF" class="root"><strong><?php
                            if ($_GET[modul] == $row_rsmmodel['id_mmodel']){
                                $content = $row_rscertfcatg['mtrl_model'];
                            }		
                            elseif ($_GET[modul]=='mat') {
                                $content = "Data All Material";
                            }
							elseif ($_GET[modul]=='munit'){
                                $content = "Data Unit";
                            }
                            elseif ($_GET[modul]=='stock'){
                                $content = "Stock of Item";
                            }
                            elseif ($_GET[modul]=='mstat'){
                                $content = "Status of Item (Asset and Inventory)";
                            }
                            elseif ($_GET[modul]=='catg') {
                                $content = "Category of Item";
                            }
  ...
  <tr>
    <td valign="top">
		<div class="glossymenu">
			<a class="menuitem submenu" href="?modul=mat">Material</a>
            <a class="menuitem submenu" href="?modul=catg">Category of Items</a>
            <?php // if ($_SESSION['userlvl'] == 'administrator') || ($_SESSION['userlvl'] == 'branchmanager') || ($_SESSION['userlvl'] == 'ppic') { // } ?>
            	<a class="menuitem submenu" href="?modul=munit">Unit</a>
				<a class="menuitem submenu" href="?modul=stock"><i>Stock of Item</i></a> 
				<a class="menuitem submenu" href="?modul=mstat"><i>Status of Item</i></a>		
		</div>
    </td>
    ...
    <iframe src="<?php
						...
						//if (isset($_GET['modul'])) {
							//echo $_GET['modul'];
							/* echo "<script>alert(\"viewallmtrl_det.php?data3=$a&data4=$b\");</script>"; */
							//echo "viewallmtrl_det.php?data3=$a&data4=$b";
						//}
						if ($_GET[modul]=='mat') {
							echo "viewallmtrl_det.php";
						}
						elseif ($_GET[modul]=='munit'){
							echo "unit_view.php";
						}
						elseif ($_GET[modul]=='stock'){
							echo "../stock_barang.php";
						}
						elseif ($_GET[modul]=='mstat'){
							echo "viewstat_item.php";
						}
						elseif ($_GET[modul]=='catg') {
							echo "view_master_catg.php";
						}
						elseif ($_GET[modul]=='unapproved'){
