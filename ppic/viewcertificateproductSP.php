...
$query_Recordset1 = "SELECT p_certificate_product.*, dms.idms, dms.fileupload, dms.id FROM p_certificate_product, dms WHERE p_certificate_product.id_category_product='2'  AND dms.keterangan=p_certificate_product.name_of_equipment AND dms.id_departemen = 'QC'  AND p_certificate_product.id_certificate=dms.idms AND p_certificate_product.activeYN = '1'";
...
<title>View Certificate Scafolding nd Plate</title>
...
<?php
	if (($_SESSION['userlvl'] == 'ppic') || ($_SESSION['userlvl'] == 'administrator') || ($_SESSION['userlvl'] == 'qly') || ($_SESSION['userlvl'] == 'branchmanager') || ($_SESSION['userlvl'] == 'project')) {
		echo '<p><a href="inputcertificateproductSP.php?data=2" id="dialog_link" class="ui-state-default ui-corner-all"><span class="ui-icon ui-icon-plusthick"></span>Add Item</a></p>';
	}
?>
<table width="1400" border="0" cellpadding="2" cellspacing="2" id="celebs">
  <thead>
    <tr class="tabel_header">
      ...
      <td width="167" rowspan="2">Name Of Equipment</td>
      <td width="93" rowspan="2">Tag / Serial Number</td>
      ...
      <td width="120" rowspan="2">Certificate No.</td>
      <td width="86" rowspan="2">Certificated By</td>
    ...
    <tr>
      <td width="44" class="tabel_header">Length (mm)</td>
      <td width="44" class="tabel_header">Height (mm)</td>
      <td width="44" class="tabel_header">Width (mm)</td>
      <td width="44" class="tabel_header">Tare Weight (kg)</td>
      <td width="44" class="tabel_header">SWL (kg)</td>
      <td width="90" class="tabel_header">Inspection Date</td>
      <td width="90" class="tabel_header">Expired Date</td>
    </tr>
  </thead>
  <tbody>
    <?php 
	...
	?>
      ...
      <td width="40" align="center"><?php { include "msg_expired.php"; } ?></td>      
      ...
      <td align="center"><?php echo functddmmmyyyy($row_Recordset1[exist_date]); ?></td>
       ...
       if (($_SESSION['userlvl'] == 'administrator') || ($_SESSION['userlvl'] == 'qly') || ($_SESSION['userlvl'] == 'ppic') || ($_SESSION['userlvl'] == 'branchmanager') || ($_SESSION['userlvl'] == 'project')) { ?>
       		<td width="33" align="center"><a href="editcertificateproductSP.php?data=<?php echo $row_Recordset1['id_certificate']; ?>">Edit</a> | <a href="deletecertificateproduct.php?data=<?php echo $row_Recordset1['id_certificate']; ?>&data1=2&data2=<?php echo $row_Recordset1['tag_serial_number']; ?>" onclick="return confirm('Delete <?php echo $row_Recordset1['name_of_equipment']; ?> with tag serial number <?php echo $row_Recordset1['tag_serial_number']; ?> ?')">Delete</a></td>
	   <?php } ?>
    </tr>
...
<table>
  <tr>
    <td><a href="#"><img src="/images/icon_printpw.gif" alt="" width="49" height="50" class="btn" onclick="MM_openBrWindow('viewcertificateproductSP_print.php','','scrollbars=yes,resizable=yes,width=1200,height=500')"/></a></td>
  </tr>
</table>
<p>&nbsp;</p>
</body>
