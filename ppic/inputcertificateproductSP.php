...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO dms (idms, id_departemen, fileupload, keterangan) VALUES (%s, %s, %s, %s)",
...
<title>Input Certificate of Scaffolding and Plate</title>
...
?>
<b>Entry Certificate of Scaffolding and Plate</b>
<br><br>
...
<table width="494" border="0" cellpadding="2" cellspacing="2">
  ...
  <tr>
    <td width="93"><b>Attachment File</b></td>
    <td width="4">:</td>
    <td width="377" ><form method="post" enctype="multipart/form-data" name="form" class="General" id="form">
