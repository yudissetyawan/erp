...
<?php
	if (($_SESSION['userlvl'] == 'ppic') || ($_SESSION['userlvl'] == 'administrator') && ($totalRows_rscoremr == 0)) { //&& ($row_Recordset3['status_approval'] != 'W')) {
		echo '<p class="btn"><a href="/ppic/inputmaterialrequestdetail.php?data='.$_GET[data].'" id="dialog_link" class="ui-state-default ui-corner-all"><span class="ui-icon ui-icon-plusthick"></span>Add Item to M/S R</a></p>';
	}
?>
