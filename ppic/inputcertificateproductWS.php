...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO p_certificate_product (id_category_product, no_certificate, name_of_equipment, length_m, diameter_inch, SWL_tons, inspection_date, expired_date, location, issued_by, exist_date, issued_user, tag_serial_number, status) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $Result1 = mysql_query($insertSQL, $core) or die(mysql_error());
    ...
    $insertGoTo = "viewcertificateproductWS.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
?>
<b>Entry Certificate of Webbing Sling</b><br><br>
...
<table border="0" cellpadding="2" cellspacing="2">
  ...
  <tr>
    <td width="91"><b>Attachment File</b></td>
    <td width="4">:</td>
...
<form action="<?php echo $editFormAction; ?><?php echo $editFormAction; ?>" method="POST" name="form1" id="form1">
  <table>
    <tr valign="middle">
      <td colspan="3" align="left"><input name="id_category_product" type="hidden" value="<?php echo $vidcat; ?>" /></td>
    </tr>
    <tr valign="middle">
    ...
    <tr valign="middle">
      ...
      <td align="left">:</td>
      <td><input type="text" name="length_m" value="" size="8" /></td>
    </tr>
    <tr valign="middle">
      <td align="left">SWL (tons)</td>
      <td align="left">:</td>
      <td><input type="text" name="SWL_tons" value="" size="8" /></td>
    </tr>
    <tr valign="middle">
      <td align="left">Diameter (inch)</td>
      <td align="left">:</td>
      <td><input type="text" name="diameter_inch" value="" size="8" /></td>
    </tr> 
    <tr valign="middle">
      <td colspan="3" align="left">&nbsp;</td>
    </tr>
    ...
    <tr valign="middle">
      <td colspan="3" align="center" nowrap="nowrap"><input type="submit" value="Save" /></td>
    </tr>
  </table>
  <p>
