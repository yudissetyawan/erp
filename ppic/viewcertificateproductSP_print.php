...
<body id="printarea">
<table width="1400" border="1" cellpadding="2" cellspacing="2" id="celebs">
  <thead>
	...
	<?php if (($_SESSION['userlvl'] == 'administrator') || ($_SESSION['userlvl'] == 'qly') || ($_SESSION['userlvl'] == 'ppic') || ($_SESSION['userlvl'] == 'branchmanager')) { echo '<td width="90" rowspan="2">&nbsp;</td>'; } ?>
    </tr>
    <tr>
...
<table>
  <tr>
    <td><img src="/images/icon_print.gif" alt="" width="50" height="50" class="btn" onclick="PrintDoc()" /></td>
  </tr>
</table>
</body>
</html>
