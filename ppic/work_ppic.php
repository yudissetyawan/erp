...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form9")) {
  $updateSQL = sprintf("UPDATE a_crf_schedulle SET materialprogress=%s, file_material=%s WHERE crf=%s",
                       GetSQLValueString($_POST['datemat'], "text"),
                       GetSQLValueString($_POST['nama_filemat'], "text"),
                       GetSQLValueString($_POST['nocrf'], "text"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form9")) {
  $insertSQL = sprintf("INSERT INTO dms (idms, id_departemen, nocrf, inisial_pekerjaan, `date`, fileupload, keterangan) VALUES (%s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['idmsmat'], "text"),
                       GetSQLValueString($_POST['id_department'], "text"),
                       GetSQLValueString($_POST['nocrf'], "text"),
                       GetSQLValueString($_POST['inisialmat'], "text"),
                       GetSQLValueString($_POST['datemat'], "text"),
                       GetSQLValueString($_POST['nama_filemat'], "text"),
                       GetSQLValueString($_POST['keteranganmat'], "text"));
  ...
  <tr>
    <td colspan="4" align="right" bgcolor="#8db4e3" class="root" id="font"><table width="600" height="17" border="0" align="left" cellpadding="0" cellspacing="0">
      <tr class="root">
        ...
        <td width="64" align="left" class="root">PPIC</td>
  ...
  <tr>
	...
	<?php
        ...
        <div id="tab-container" class='tab-container'>
         <ul class='etabs'>
           <li class='tab'><a href="#tabs1-mat">Material for CRF</a></li>
           <li class='tab'><a href="#tabs1-as">Asset</a></li>
           <li class='tab'><a href="#tabs1-pn">Planning</a></li>
           <li class='tab'><a href="#tabs1-cl">Controling</a></li>
           <li class='tab'><a href="#tabs1-iv">Inventory</a></li>
         </ul>
           
         <div class='panel-container'>
         <div id="tabs1-mat">
         <h2>Material for CRF</h2>
         <?php { include "uploadmat.php"; } ?>
         <form method="post" enctype="multipart/form-data" name="form" class="General" id="form">
               Attachment File:
               <input name="filemat" type="file" style="cursor:pointer;" />
               <input type="submit" name="submit6" value="Upload" />
               
          <form method="POST" action="<?php echo $editFormAction; ?>" id="form9" name="form9">
               <input type="hidden" name="nocrf" id="nocrf" value="<?php echo $row_Recordset1['nocrf']; ?>" />
               <input name="nama_filemat" type="hidden" id="nama_filemat" value="<?php echo $nama_file;?>"/>
               <input name="datemat" type="hidden" id="datemat" value="<?php echo $tanggal;?>"/>
               <input name="inisialmat" type="hidden" id="inisialmat" value="MAT"/>
               <input type="hidden" name="id_department" id="id_department" value="ppic" />
               <p>
                 <textarea name="keteranganmat" id="keteranganmat" cols="45" rows="5"></textarea>
                 <input name="idmsmat" type="hidden" id="idmsmat" value="<?php echo $row_Recordset1['idms']; ?>" />
               </p>
          ...
          <div id="tabs1-as">
             ...
             <form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST">
               ...
               <input name="inisialas" type="hidden" id="inisialas" value="AS"/>
               <input type="hidden" name="id_department" id="id_department" value="ppic" />
               <p>
          ...
          <div id="tabs1-pn">
           ...
           <form action="<?php echo $editFormAction; ?>" id="form4" name="form4" method="POST">
             ...
             <input name="nama_filepn" type="hidden" id="nama_filepn" value="<?php echo $nama_file;?>"/>
               ...
               <input name="inisialpn" type="hidden" id="inisialpn" value="PN"/>
               <input type="hidden" name="id_department2" id="id_department2" value="ppic" />
               <p>
          ...
          <div id="tabs1-cl">
           ...
           <form action="<?php echo $editFormAction; ?>" id="form6" name="form6" method="POST">
             ...
             <input name="nama_filecl" type="hidden" id="nama_filecl" value="<?php echo $nama_file;?>"/>
               ...
               <input name="inisialcl" type="hidden" id="inisialcl" value="CL"/>
               <input type="hidden" name="id_department3" id="id_department3" value="ppic" />
               <p>
          ...
          <div id="tabs1-iv">
           ...
           <form id="form6" name="form6" method="POST" action="<?php echo $editFormAction; ?>">
             ...
             <input name="nama_fileiv" type="hidden" id="nama_fileiv" value="<?php echo $nama_file;?>"/>
               ...
               <input name="inisialiv" type="hidden" id="inisialiv" value="IV"/>
               <input type="hidden" name="id_department4" id="id_department4" value="ppic" />
               <p>
