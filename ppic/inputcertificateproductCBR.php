...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO p_certificate_product (id_category_product, name_of_equipment, tag_serial_number, length_mm, height_mm, width_mm, tare_weight_kg, SWL_kg, gross_weight_kg, inspection_date, expired_date, location, issued_by, exist_date, issued_user, no_certificate, status) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "viewcertificateproductCBR.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<title>Input Certificate of Cylinder Bottle Rack</title>
...
?>
<b>Entry Certificate of Cylinder Bottle Rack</b><br><br>
...
<table width="494" border="0" cellpadding="2" cellspacing="2">
  ...
  <tr>
    <td width="91"><strong>Attachment File </strong></td>
    <td width="4">:</td>
    <td width="379" ><form method="post" enctype="multipart/form-data" name="form" class="General" id="form">
...
<form action="<?php echo $editFormAction; ?><?php echo $editFormAction; ?>" method="POST" name="form1" id="form1">
  <table>
    ...
    <tr valign="middle">
      ...
      <td align="left">:</td>
      <td><input type="text" name="gross_weight_kg" value="" size="8" /></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr valign="middle">
      <td colspan="6" align="right"><input type="submit" value="Save" style="cursor:pointer" /></td>
    </tr>
  </table>
  <p>
