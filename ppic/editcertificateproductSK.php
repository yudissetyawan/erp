...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateGoTo = "viewcertificateproductSK.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_core, $core);
$query_Recordset1 = sprintf("SELECT p_certificate_product.*, dms.idms, dms.fileupload, dms.id, dms.id_departemen FROM p_certificate_product, dms WHERE p_certificate_product.id_category_product='3' AND dms.keterangan=p_certificate_product.name_of_equipment AND dms.id_departemen = 'QC'  AND dms.idms=p_certificate_product.id_certificate AND p_certificate_product.id_certificate = %s", GetSQLValueString($colname_Recordset1, "int"));
...
<title>Edit Certificate of Skid</title>
</head>
...
<label style="font-weight:bold" <?php echo $vhidden; ?> >Edit Certificate of Skid</label>
<br /><br />
...
<table border="0" cellpadding="2" cellspacing="2" <?php echo $vhidden; ?> >
  ...
  <tr>
    <td width="95">Attachment File</td>
    <td width="3">:</td>
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" id="form1">
  <table>
    ...
    <tr valign="middle">
      ...
      <td align="left">:</td>
      <td><input type="text" name="issued_by" value="<?php echo $row_Recordset1['issued_by']; ?>" size="32" <?php echo $vdisabled; ?> /></td>
    </tr>
    <tr valign="middle">
      ...
      <td align="left">:</td>
      <td><input type="text" name="location" value="<?php echo $row_Recordset1['location']; ?>" size="32" <?php echo $vdisabled; ?> /></td>
    </tr>
    <tr valign="middle">
