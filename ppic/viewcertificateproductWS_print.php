...
$query_Recordset1 = "SELECT p_certificate_product.*, dms.idms, dms.id, dms.fileupload FROM p_certificate_product, dms WHERE p_certificate_product.id_category_product='8'  AND dms.keterangan=p_certificate_product.name_of_equipment AND dms.id_departemen = 'QC'  AND p_certificate_product.id_certificate=dms.idms AND p_certificate_product.activeYN = '1'";
...
<title>View Certificate of Webbing Sling</title>
...
<table width="1350" border="1" cellpadding="2" cellspacing="2" id="celebs">
  ...
  <tr class="tabel_header">
    ...
    <td rowspan="2" width="167" align="center"><strong>Name Of Equipment</strong></td>
    <td rowspan="2" width="93" align="center"><strong>Tag / Serial Number</strong></td>
    <td colspan="3" align="center"><strong>Specification</strong></td>
    <td colspan="2" align="center"><strong>Validation Date</strong></td>
    <td rowspan="2" align="center" title="Code color now (<?php echo date("F Y");?>)"><strong>Status</strong></td>
    <td rowspan="2" align="center"><strong>Day Remaining</strong></td>
    <td rowspan="2" align="center" width="190"><strong>Location</strong></td>
    <td rowspan="2" align="center" width="146"><strong>Certificate No.</strong></td>
    <td rowspan="2" align="center" width="86"><strong>Certificated by</strong></td>
    <td width="100" align="center" rowspan="2"><strong>Updated by</strong></td>
    <?php if (($_SESSION['userlvl'] == 'administrator') || ($_SESSION['userlvl'] == 'qly') || ($_SESSION['userlvl'] == 'ppic') || ($_SESSION['userlvl'] == 'branchmanager')) { echo '<td rowspan="2">&nbsp;</td>'; } ?>
    </tr>
  <tr class="tabel_header">
    <td class="tabel_header" align="center" width="44"><strong>Length (m)</strong></td>
    <td class="tabel_header" align="center" width="44"><strong>SWL (tons)</strong></td>
    <td class="tabel_header" align="center" width="44"><strong>Diameter (inch)</strong></td>
    
    <td class="tabel_header" align="center" width="95"><strong>Inspection Date</strong></td>
    <td class="tabel_header" align="center" width="95"><strong>Expired Date</strong></td>
  </tr>
  </thead>
  <tbody>
    <?php 
	...
	?>
      <tr class="tabel_body" ondblclick="this.style.fontWeight='bold';" onclick="this.style.fontWeight='normal';" title="Double click data for 'highlight', and one click to remove highlight"><?php $a=$a+1 ?>
        ...
        <td align="center"><?php echo $row_Recordset1['length_m']; ?></td>
        <td align="center"><?php echo $row_Recordset1['SWL_tons']; ?></td>
        <td align="center"><?php echo $row_Recordset1['diameter_inch']; ?></td>
