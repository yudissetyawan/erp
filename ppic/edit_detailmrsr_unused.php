...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE p_mr_core SET itemmr=%s, qty=%s, dateinuse=%s, tobeuse=%s, remark=%s, mrheader=%s WHERE id=%s",
                       GetSQLValueString($_POST['cmbModel'], "text"),
                       GetSQLValueString($_POST['qty'], "int"),
                       GetSQLValueString($_POST['dateinuse'], "date"),
                       GetSQLValueString($_POST['tobeuse'], "text"),
                       GetSQLValueString($_POST['remark'], "text"),
                       GetSQLValueString($_POST['mrheader'], "text"),
...
mysql_select_db($database_core, $core);
$query_Recordset4 = "SELECT * FROM p_mr_header";
...
mysql_select_db($database_core, $core);
$query_Recordset9 = sprintf("SELECT * FROM p_mr_core WHERE id = %s", GetSQLValueString($colname_Recordset9, "int"));
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" class="General" id="form1">
  <table width="620" border="0" class="General">
    ...
    <tr>
      ...
      <td>:</td>
      <td><input name="qty" type="text" class="required" id="qty" title="Quantity is required" value="<?php echo $row_Recordset9['qty']; ?>" />
...
?>
        ...
        <a href="inputunit.php">Input Unit</a></td>
    </tr>
    <tr>
      <td class="General">Date In Use</td>
      <td>:</td>
      <td><input name="dateinuse" type="text" class="required" id="tanggal1" title="Please select date in use" value="<?php echo $row_Recordset9['dateinuse']; ?>"/></td>
    </tr>
    <tr>
      <td class="General">To Be Use</td>
      <td>:</td>
      <td><input name="tobeuse" type="text" class="required" id="tobeuse" title="Please select to be use" value="<?php echo $row_Recordset9['tobeuse']; ?>" size="52" /></td>
    </tr>
    <tr>
      <td class="General">Remark</td>
      <td>:</td>
      <td><textarea name="remark" id="remark" cols="40" rows="4" class="required" title="Remark is required"><?php echo $row_Recordset9['remark']; ?></textarea></td>
    </tr>
    <tr>
      <td align="center" colspan="3" class="General">
      <input name="mrheader" type="hidden" id="mrheader" value="<?php echo $row_Recordset3['id']; ?>" />
