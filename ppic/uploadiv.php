    ...
    if(isset($_POST[submit4])){
     ...
     $nama_file = $_FILES['fileiv']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['fileiv']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['fileiv']['tmp_name']; //Nama file sementara
