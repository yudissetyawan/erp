...
echo 'Item Code &nbsp; : <input type="text" name="itemcd" id="itemcd" readonly="readonly" value="'.$row['item_code'].'" disabled />
      <br /><br />
      Specification : <br />
	  <textarea name="spec" id="spec" cols="40" rows="2" value="'.$row['descr_spec'].'" disabled /></textarea>';
	?>
    ...
    <a href="inputunit.php">Input Unit</a>
    <br /><br />
