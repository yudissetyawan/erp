    ...
    if(isset($_POST[submit3])){
     ...
     $nama_file = $_FILES['filecl']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filecl']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filecl']['tmp_name']; //Nama file sementara
