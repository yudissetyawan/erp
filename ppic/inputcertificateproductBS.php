...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO p_certificate_product (id_category_product, name_of_equipment, tag_serial_number, size_inch, brand, model, inspection_date, expired_date, location, issued_by, exist_date, issued_user, no_certificate, status) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "viewcertificateproductBS.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<title>Input Certificate of Bow Shackles</title>
...
<b>Entry Certificate of Bow Shackles</b>
<br><br>
...
<form action="<?php echo $editFormAction; ?><?php echo $editFormAction; ?>" method="POST" name="form1" id="form1">
  <table>
    ...
    <tr valign="middle">
      ...
      <td align="left">:</td>
      <td><input type="text" name="size_inch" value="" size="8" /></td>
    </tr>
    <tr valign="middle">
