...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateSQL = sprintf("UPDATE p_certificate_product SET id_category_product=%s, name_of_equipment=%s, tag_serial_number=%s, size_inch=%s, brand=%s, model=%s, inspection_date=%s, expired_date=%s, location=%s, issued_by=%s, exist_date=%s, issued_user=%s, no_certificate=%s, status=%s WHERE id_certificate=%s",
                       ...
                       GetSQLValueString($_POST['size_inch'], "text"),
  ...
  $updateGoTo = "viewcertificateproductBS.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_core, $core);
$query_Recordset1 = sprintf("SELECT p_certificate_product.*, dms.idms, dms.fileupload, dms.id, dms.id_departemen FROM p_certificate_product, dms WHERE p_certificate_product.id_category_product='6'  AND dms.keterangan=p_certificate_product.name_of_equipment AND dms.id_departemen = 'QC'  AND dms.idms=p_certificate_product.id_certificate AND p_certificate_product.id_certificate = %s", GetSQLValueString($colname_Recordset1, "int"));
...
<title>Edit Certificate of Bow Shackles</title>
</head>
...
<label style="font-weight:bold" <?php echo $vhidden; ?> >Edit Certificate of Bow Shackles</label>
<br /><br />
...
<table border="0" cellpadding="2" cellspacing="2" <?php echo $vhidden; ?> >
  ...
  <tr>
    <td width="107"><b>Attachment File</b></td>
    <td width="3">:</td>
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" id="form1">
  <table>
    ...
    <tr valign="middle">
      ...
      <td align="left">:</td>
      <td><input type="text" name="no_certificate" value="<?php echo $row_Recordset1['no_certificate']; ?>" size="40" <?php echo $vdisabled; ?> /></td>
    </tr>
    <tr valign="middle">
      <td valign="top" align="left">Name of Equipment</td>
      <td valign="top" align="left">:</td>
      <td><textarea name="name_of_equipment" cols="40" <?php echo $vdisabled; ?> ><?php echo $row_Recordset1['name_of_equipment']; ?></textarea></td>
    </tr>
    <tr valign="middle">
      <td valign="top" align="left">Tag Serial Number</td>
      <td valign="top" align="left">:</td>
    ...
    <tr valign="middle">
      ...
      <td align="left">:</td>
      <td><input type="text" name="size_inch" value="<?php echo $row_Recordset1['size_inch']; ?>" size="8" <?php echo $vdisabled; ?> /></td>
    </tr>
    <tr valign="middle">
      <td align="left">Brand</td>
      <td align="left">:</td>
      <td><input type="text" name="brand" value="<?php echo $row_Recordset1['brand']; ?>" size="15" <?php echo $vdisabled; ?> /></td>
    </tr>
    <tr valign="middle">
      <td align="left">Model</td>
      <td align="left">:</td>
      <td><input type="text" name="model" value="<?php echo $row_Recordset1['model']; ?>" size="15" <?php echo $vdisabled; ?> /></td>
    </tr>
    <tr valign="middle">
      <td colspan="3" align="left">&nbsp;</td>
    </tr>
