...
?>
<table width="1400" border="0" cellpadding="2" cellspacing="2" class="table" id="celebs">
<thead>
  ...
  <tbody>
	...
	?>
       ...
       if (($_SESSION['userlvl'] == 'administrator') || ($_SESSION['userlvl'] == 'qly') || ($_SESSION['userlvl'] == 'ppic') || ($_SESSION['userlvl'] == 'branchmanager') || ($_SESSION['userlvl'] == 'project')) { ?>
       		<td width="25" align="center"><a href="editcertificateproductSL.php?data=<?php echo $row_Recordset1['id_certificate']; ?>">Edit</a> | <a href="deletecertificateproduct.php?data=<?php echo $row_Recordset1['id_certificate']; ?>&data1=5&data2=<?php echo $row_Recordset1['tag_serial_number']; ?>" onclick="return confirm('Delete <?php echo $row_Recordset1['name_of_equipment']; ?> with tag serial number <?php echo $row_Recordset1['tag_serial_number']; ?> ?')">Delete</a></td>
	   <?php } ?>
      </tr>
...
<table>
  <tr>
    <td><a href="#"><img src="/images/icon_printpw.gif" alt="" width="49" height="50" class="btn" onclick="MM_openBrWindow('viewcertificateproductSL_print.php','','scrollbars=yes,resizable=yes,width=1200,height=500')"/></a></td>
  </tr>
</table>
<p>&nbsp;</p>
