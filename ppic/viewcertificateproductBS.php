...
$query_Recordset1 = "SELECT p_certificate_product.*, dms.idms, dms.id, dms.fileupload FROM p_certificate_product, dms WHERE p_certificate_product.id_category_product='6'  AND dms.keterangan=p_certificate_product.name_of_equipment AND dms.id_departemen = 'QC'  AND p_certificate_product.id_certificate=dms.idms AND p_certificate_product.activeYN = '1'";
...
<title>View Certificated Product Bow Shackles</title>
...
<?php
	if (($_SESSION['userlvl'] == 'ppic') || ($_SESSION['userlvl'] == 'administrator') || ($_SESSION['userlvl'] == 'qly') || ($_SESSION['userlvl'] == 'branchmanager') || ($_SESSION['userlvl'] == 'project')) {
		echo '<p><a href="inputcertificateproductBS.php?data=6" id="dialog_link" class="ui-state-default ui-corner-all"><span class="ui-icon ui-icon-plusthick"></span>Add Item</a></p>';
	}
?>
...
<thead>
  <tr class="tabel_header">
    ...
    <td width="134" rowspan="2">Name Of Equipment</td>
    <td width="125" rowspan="2">Tag /Serial Number</td>
    ...
    <td width="200" rowspan="2">Location</td>
    <td width="100" rowspan="2">Certificate No.</td>
    <td width="80" rowspan="2">Certificated By</td>
    <td width="100" rowspan="2">Updated by</td>
    <td width="90" rowspan="2">Update</td>
    <?php if (($_SESSION['userlvl'] == 'administrator') || ($_SESSION['userlvl'] == 'qly') || ($_SESSION['userlvl'] == 'ppic') || ($_SESSION['userlvl'] == 'branchmanager') || ($_SESSION['userlvl'] == 'project')) {
		echo '<td width="90" rowspan="2">&nbsp;</td>'; } ?>
    </tr>
  <tr>
    <td width="44" class="tabel_header">Size (inch)</td>
    <td width="44" class="tabel_header">Brand</td>
    <td width="44" class="tabel_header">Model</td>
    
    <td width="95" class="tabel_header">Inspection Date</td>
    <td width="95" class="tabel_header">Expired Date</td>
  </tr>
  </thead>
  <tbody>
    <?php 
  ...
  <td align="center"><?php echo $a; ?></td>
        ...
        <td align="center"><?php echo $row_Recordset1[size_inch]; ?></td>
        <td><?php echo $row_Recordset1[brand]; ?></td>
        <td align="center"><?php echo $row_Recordset1[model]; ?></td>
       ...
       <td width="46" align="center"><?php { include "msg_expired.php"; } ?></td>
        
        <td><?php echo $row_Recordset1['location']; ?></td>
        
        <td align="center"><?php if ($row_Recordset1['fileupload'] == "") {
      ...
      <td align="center"><?php echo functddmmmyyyy($row_Recordset1[exist_date]); ?></td>
       ...
       if (($_SESSION['userlvl'] == 'administrator') || ($_SESSION['userlvl'] == 'qly') || ($_SESSION['userlvl'] == 'ppic') || ($_SESSION['userlvl'] == 'branchmanager') || ($_SESSION['userlvl'] == 'project')) { ?>
       		<td width="35" align="center"><a href="editcertificateproductBS.php?data=<?php echo $row_Recordset1['id_certificate']; ?>">Edit</a> | <a href="deletecertificateproduct.php?data=<?php echo $row_Recordset1['id_certificate']; ?>&data1=6&data2=<?php echo $row_Recordset1['tag_serial_number']; ?>" onclick="return confirm('Delete <?php echo $row_Recordset1['name_of_equipment']; ?> with tag serial number <?php echo $row_Recordset1['tag_serial_number']; ?> ?')">Delete</a></td>
	   <?php } ?>
      </tr>
...
<table>
  <tr>
    <td><a href="#"><img src="/images/icon_printpw.gif" alt="" width="24" height="25" class="btn" onclick="MM_openBrWindow('viewcertificateproductBS_print.php','','scrollbars=yes,resizable=yes,width=1200,height=500')"/></a></td>
  </tr>
</table>
<p>&nbsp;</p>
</body>
