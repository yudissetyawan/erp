...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateSQL = sprintf("UPDATE p_certificate_product SET id_category_product=%s, name_of_equipment=%s, tag_serial_number=%s, brand=%s, type=%s, WLL_tons=%s, inspection_date=%s, expired_date=%s, location=%s, issued_by=%s, exist_date=%s, issued_user=%s, no_certificate=%s, status=%s WHERE id_certificate=%s",
  ...
  $updateGoTo = "viewcertificateproductCB.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_core, $core);
$query_Recordset1 = sprintf("SELECT p_certificate_product.*, dms.idms, dms.fileupload, dms.id, dms.id_departemen FROM p_certificate_product, dms WHERE p_certificate_product.id_category_product='7'  AND dms.keterangan=p_certificate_product.name_of_equipment AND dms.id_departemen = 'QC'  AND dms.idms=p_certificate_product.id_certificate AND p_certificate_product.id_certificate = %s", GetSQLValueString($colname_Recordset1, "int"));
...
<title>Edit Certificate of Chain Block</title>
</head>
...
<label style="font-weight:bold" <?php echo $vhidden; ?> >Edit Certificate of Chain Block</label>
<br /><br />
...
<form action="<?php echo $editFormAction; ?>" method="POST" name="form1" id="form1">
  <table>
    ...
    <tr valign="middle">
      ...
      <td align="left">:</td>
      <td><input type="text" name="type" value="<?php echo $row_Recordset1['type']; ?>" size="15" <?php echo $vdisabled; ?> /></td>
    </tr>
    <tr valign="middle">
