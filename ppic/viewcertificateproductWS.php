...
<?php
	if (($_SESSION['userlvl'] == 'ppic') || ($_SESSION['userlvl'] == 'administrator') || ($_SESSION['userlvl'] == 'qly') || ($_SESSION['userlvl'] == 'branchmanager') || ($_SESSION['userlvl'] == 'project')) {
		echo '<p><a href="inputcertificateproductWS.php?data=8" id="dialog_link" class="ui-state-default ui-corner-all"><span class="ui-icon ui-icon-plusthick"></span>Add Item</a></p>';
	}
?>
...
<thead>
  <tr class="tabel_header">
    ...
    <?php if (($_SESSION['userlvl'] == 'administrator') || ($_SESSION['userlvl'] == 'qly') || ($_SESSION['userlvl'] == 'ppic') || ($_SESSION['userlvl'] == 'branchmanager') || ($_SESSION['userlvl'] == 'project')) { echo '<td rowspan="2">&nbsp;</td>'; } ?>
    </tr>
  <tr class="tabel_header">
    <td class="tabel_header" width="44">Length (m)</td>
    <td class="tabel_header" width="44">SWL (tons)</td>
    <td class="tabel_header" width="44">Diameter (inch)</td>
	...
	?>
      ...
      <td align="center"><?php echo functddmmmyyyy($row_Recordset1[exist_date]); ?></td>
       ...
       if (($_SESSION['userlvl'] == 'administrator') || ($_SESSION['userlvl'] == 'qly') || ($_SESSION['userlvl'] == 'ppic') || ($_SESSION['userlvl'] == 'branchmanager') || ($_SESSION['userlvl'] == 'project')) { ?>
       		<td align="center"><a href="editcertificateproductWS.php?data=<?php echo $row_Recordset1['id_certificate']; ?>">Edit</a> | <a href="deletecertificateproduct.php?data=<?php echo $row_Recordset1['id_certificate']; ?>&data1=8&data2=<?php echo $row_Recordset1['tag_serial_number']; ?>" onclick="return confirm('Delete <?php echo $row_Recordset1['name_of_equipment']; ?> with tag serial number <?php echo $row_Recordset1['tag_serial_number']; ?> ?')">Delete</a></td>
	   <?php } ?>
      </tr>
...
<table>
  <tr>
    <td><a href="#"><img src="/images/icon_printpw.gif" alt="" width="49" height="50" class="btn" onclick="MM_openBrWindow('viewcertificateproductCB_print.php','','scrollbars=yes,resizable=yes,width=1200,height=500')"/></a></td>
  </tr>
</table>
<p>&nbsp;</p>
</body>
