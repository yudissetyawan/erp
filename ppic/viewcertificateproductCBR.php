...
$query_Recordset1 = "SELECT p_certificate_product.*, dms.idms, dms.fileupload, dms.id FROM p_certificate_product, dms WHERE p_certificate_product.id_category_product='4'  AND dms.keterangan=p_certificate_product.name_of_equipment AND dms.id_departemen = 'QC'  AND p_certificate_product.id_certificate=dms.idms AND p_certificate_product.activeYN = '1'";
...
<title>View Certificated Product Cylinder Bottle Rack</title>
...
<?php
	if (($_SESSION['userlvl'] == 'ppic') || ($_SESSION['userlvl'] == 'administrator') || ($_SESSION['userlvl'] == 'qly') || ($_SESSION['userlvl'] == 'branchmanager') || ($_SESSION['userlvl'] == 'project')) {
		echo '<p><a href="inputcertificateproductCBR.php?data=4" id="dialog_link" class="ui-state-default ui-corner-all"><span class="ui-icon ui-icon-plusthick"></span>Add Item</a></p>';
	}
?>

<table width="1375" border="0" cellpadding="2" cellspacing="2" id="celebs">
  <thead>
    <tr class="tabel_header">
      ...
      <td rowspan="2" width="170">Location</td>
      <td rowspan="2" width="150">Certificate No.</td>
      <td rowspan="2">Certificated By</td>
	...
	?>
      ...
      <td align="center"><?php echo functddmmmyyyy($row_Recordset1[exist_date]); ?></td>
       ...
       if (($_SESSION['userlvl'] == 'administrator') || ($_SESSION['userlvl'] == 'qly') || ($_SESSION['userlvl'] == 'ppic') || ($_SESSION['userlvl'] == 'branchmanager') || ($_SESSION['userlvl'] == 'project')) { ?>
       		<td align="center"><a href="editcertificateproductCBR.php?data=<?php echo $row_Recordset1['id_certificate']; ?>">Edit</a> | <a href="deletecertificateproduct.php?data=<?php echo $row_Recordset1['id_certificate']; ?>&data1=4&data2=<?php echo $row_Recordset1['tag_serial_number']; ?>" onclick="return confirm('Delete <?php echo $row_Recordset1['name_of_equipment']; ?> with tag serial number <?php echo $row_Recordset1['tag_serial_number']; ?> ?')">Delete</a></td>
	   <?php } ?>
    </tr>
