...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateGoTo = "viewcertificateproductCBR.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_core, $core);
$query_Recordset1 = sprintf("SELECT p_certificate_product.*, dms.idms, dms.fileupload, dms.id, dms.id_departemen FROM p_certificate_product, dms WHERE p_certificate_product.id_category_product='4' AND dms.keterangan=p_certificate_product.name_of_equipment AND dms.id_departemen = 'QC' AND dms.idms=p_certificate_product.id_certificate AND p_certificate_product.id_certificate = %s", GetSQLValueString($colname_Recordset1, "int"));
...
<title>Edit Certificate of Cylinder Bottle Rack</title>
</head>
...
<label style="font-weight:bold" <?php echo $vhidden; ?> >Edit Certificate of Cylinder Bottle Rack</label>
<br /><br />
