    ...
    if(isset($_POST[submit6])){
     $direktori = '../ppic/upload/'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['filemat']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filemat']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filemat']['tmp_name']; //Nama file sementara
