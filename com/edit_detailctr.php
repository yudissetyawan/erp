...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE c_ctr_detailklo SET drawingnumber=%s, afecc=%s, engineeringservices=%s, projectservices=%s, structurestotalmaterialsupply=%s, structurestotalfabrication=%s, structurestotalinstallation=%s, structurestotalpainting=%s, pipingtotalmaterialsupply=%s, pipingtotalfabrication=%s, pipingtotalinstallation=%s, pipingtotalpainting=%s, electricaltotalmaterialsupply=%s, electricaltotalinstallation=%s, instrumentationtotalmaterialsupply=%s, instrumentationtotalinstallation=%s, pwht=%s, ndt=%s, landtransportation=%s, civilwork=%s, personeldayrate=%s, equipmentdayrate=%s, totalwovalue=%s WHERE idctr=%s",
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE c_total_ctr SET total_eng=%s, total_stuc=%s, total_pipings=%s, total_elect=%s, total_instrument=%s, total_pwht=%s, total_ndt=%s, total_transport=%s, total_civil=%s, total_personel=%s, total_wovalue=%s WHERE id_ctr=%s",
...
<script type="text/javascript" src="../js/jquery.validate.pack"></script>
<? //eng services ?>
...
<form method="POST" action="<?php echo $editFormAction; ?>" name="form1">
  ...
  <table width="606">
    ...
    <tr class="tabel_header">
      ...
      <td>&nbsp;</td>
      <td><input name="total_eng" type="text" style="border:thin; background:79BAEC;" onFocus="startCal();" onBlur="stopCal();" value="<?php echo $row_Recordset3['total_eng']; ?>" /></td>
    </tr>
    <tr>
