    ...
    if(isset($_POST[submit1])){
     $direktori = '../com/upload_comm/'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['filectr']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filectr']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filectr']['tmp_name']; //Nama file sementara
