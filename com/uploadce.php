    ...
    if(isset($_POST[submit4])){
     ...
     $nama_file = $_FILES['filece']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filece']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filece']['tmp_name']; //Nama file sementara
