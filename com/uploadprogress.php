    ...
    if(isset($_POST[submit])){
     $direktori = '../com/upload_comm/pg/'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['filepg']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filepg']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filepg']['tmp_name']; //Nama file sementara
