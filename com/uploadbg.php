    ...
    if(isset($_POST[submit3])){
     ...
     $nama_file = $_FILES['filebg']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filebg']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filebg']['tmp_name']; //Nama file sementara
