...
<table width="1000" border="1" cellspacing="0" cellpadding="0" class="buatform">
  <tr>
    <td width="1017"><p align="center"><span id="result_box" lang="en"><strong>Please Select Project Code</strong></span></p>
...
?>
	  ...
	  if(!empty($cari)){
	  ?>
      <p align="center"><strong> Find Results</strong> - <strong>CRF Data</strong></p>
      <p>
        <?
  ...
  <tr>
    <td width="950"><p align="center">&nbsp;</p>
      ...
      <p>
		...
		$sql=mysql_query("SELECT * FROM a_production_code WHERE a_production_code.projectcode LIKE '%$cari%' ORDER BY productioncode ASC ");
	  $totalseluruhpendaftar=mysql_num_rows($sql);
	  if($totalseluruhpendaftar=='0'){
	 echo "<center><blink>No data available in table </bink></center>";
	  ...
	  ?>
      <table width="1035" border="0" cellspacing="1" cellpadding="0">
        <tr class="tabel_header">
          <th colspan="2" >
     <?
while($sql2=mysql_fetch_array($not)){
	  ?>
        ...
        <tr class="tabel_header">
          <th width="37" class="tabel_header">No.</th>
          <th width='133' class="tabel_header">Production Code</th>
          <th width='632' class="tabel_header">Job Title</th>
          <th width='69' class="tabel_header">Quantity</th>
          <th width='158' class="tabel_header">Contact Person</th>
         </tr>
        <?
while($sql1=mysql_fetch_array($sql)){
	  ?>
        <tr class="tabel_body">
          ...
          <td><a href="view_productioncode.php?data=<?php echo $sql1['id']; ?>"><?php echo $sql1[projectcode]."-".$sql1[productioncode];?></a></td>
          <td ><?php echo $sql1[projecttitle];?></td>
