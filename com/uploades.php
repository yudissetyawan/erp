    ...
    if(isset($_POST[submit2])){
     $direktori = '../com/upload_comm/es/'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['filees']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filees']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filees']['tmp_name']; //Nama file sementara
