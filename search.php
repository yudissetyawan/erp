...
mysql_select_db($database_core, $core);
$query_Recordset2 = "SELECT log_pesan.*, inisial_pekerjaan.inisial_pekerjaan FROM log_pesan, inisial_pekerjaan WHERE log_pesan.id_empdept = '$usrid' AND log_pesan.sudah_bacaYN = 'Y' AND inisial_pekerjaan.id_inisial=log_pesan.id_inisial ORDER BY log_pesan.waktu_notif DESC";
