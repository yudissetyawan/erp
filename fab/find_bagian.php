...
do {  
?>
                <option value="<?php echo $row_sql1['skill']?>"><?php echo $row_sql1['skill']?></option>
                <?php
...
?>
	...
	if (!empty($cari)) {
      ...
      <p align="center"><b>Employee Data :</b></p>
		<p>
	      <?php
		$sql1 = mysql_query("SELECT f_manpower_loading.*, h_employee.id, h_employee.nik, h_employee.firstname, h_employee.midlename, h_employee.lastname, h_employee.department FROM f_manpower_loading, h_employee WHERE f_manpower_loading.employee=h_employee.id AND f_manpower_loading.skill = '$cari'");
	  	$row_sql1 = mysql_fetch_assoc($sql1);
