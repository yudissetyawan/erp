    ...
    if(isset($_POST[submit])){
     $direktori = '../fab/upload/mp/'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['filemp']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filemp']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filemp']['tmp_name']; //Nama file sementara
