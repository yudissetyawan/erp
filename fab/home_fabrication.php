...
$MM_authorizedUsers = "administrator,branchmanager,ppic,fabrication";
...
$MM_restrictGoTo = "/home.php?pesan=Sorry You re not Alowed to access Fabrication Section";
...
<table width="1270" border="0" align="center">
  <tr>
    ...
    <td width="646" align="right" valign="top"><table width="439" border="0" align="right" cellpadding="1" cellspacing="1">
  ...
  <tr>
    <td align="right" bgcolor="#8db4e3" class="tabel_index" id="font">Fabrication Menu</td>
    <td colspan="2" align="right" bgcolor="#8db4e3" id="font"><table width="273" height="17" border="0" align="left" cellpadding="0" cellspacing="0">
      <tr class="root">
        <td width="37" bgcolor="#EFEFEF" class="root"><a href="../home.php">Home</a></td>
        <td width="6" align="right" bgcolor="#EFEFEF" class="root">|</td>
        <td width="60" align="right" bgcolor="#EFEFEF" class="root">Fabrication</td>
        <td width="170" align="right" bgcolor="#EFEFEF" class="root"><?php
                    	if($_GET[modul]=='project'){
							$content="Project Handling";
							}
						elseif ($_GET[modul]=='report'){
							$content="Daily Report";
							}
						elseif ($_GET[modul]=='mpl'){
							$content="Manpower Alocation";
							}
						elseif ($_GET[modul]=='activity'){
							$content="Monitoring Activity";
							}
						elseif ($_GET[modul]=='mrmonitoring'){
							$content="Monitoring MR";
							}
						elseif ($_GET[modul]=='action'){
							$content="Monitoring MR Action";
							}	
  ...
  <tr>
    <td valign="top"><div class="glossymenu"> <a class="menuitem submenu" href="?modul=project">Project Handling</a>
                  <a class="menuitem submenu" href="?modul=mpl">Manpower Allocation</a>
                   <a class="menuitem submenu" href="?modul=report">Daily Report</a>
 	    
            
    </div></td>
    <td colspan="2">
    <iframe src="<?php
                    	if($_GET[modul]=='report'){
							echo "viewdailyreport.php";
							}
						elseif ($_GET[modul]=='project'){
							echo "form_fab.php";
							}
						elseif ($_GET[modul]=='activity'){
							echo "viewmonitoringactivity.php";
							}
						elseif ($_GET[modul]=='mrmonitoring'){
							echo "viewmonitoringactivity.php";
							}
						elseif ($_GET[modul]=='action'){
							echo "viewmrmonitoringaction.php";
							}
						elseif ($_GET[modul]=='report'){
							echo "daily_report.php";
							}
						elseif ($_GET[modul]=='mpl'){
							echo "mpl&selection.php";
							}
						...
						elseif ($_GET[modul]=='notif'){
							...
							echo "flash/fabricationmanufacturing.html";
							}
					?>" frameborder="0" width="1075" height="550"> </iframe>    </td>
  </tr>
  <tr>
    <td width="174">&nbsp;</td>
    <td width="436" class="pesan"><?php echo $_GET['pesan']; ?></td>
