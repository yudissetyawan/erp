    ...
    if(isset($_POST[submit3])){
     ...
     $nama_file = $_FILES['fileik']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['fileik']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['fileik']['tmp_name']; //Nama file sementara
