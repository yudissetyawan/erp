...
$query_sql1 = "SELECT f_manpower_loading.*, h_employee.id, h_employee.nik, h_employee.firstname, h_employee.midlename, h_employee.lastname, h_employee.department FROM f_manpower_loading, h_employee WHERE f_manpower_loading.employee=h_employee.id  ";
...
<table width="1000" border="1" cellspacing="0" cellpadding="0">
  <tr>
    <td width="1017"><p align="center"><strong>PENCARIAN DATA BULAN <?php echo $row_Recordset1['month']; ?></strong></p>
      <form id="form1" name="form1" method="post" action="">
        <div align="center">
          <table width="419" border="0" cellspacing="2" cellpadding="0">
            <tr>
              <td class="General">Pencarian Berdasarkan Lokasi</td>
              <td>:</td>
...
do {  
?>
                <option value="<?php echo $row_Recordset3['id']?>"><?php echo $row_Recordset3['nama_site']?></option>
                <?php
...
?>
	...
	if (!empty($cari)) {
		...
		<p>
		<?php
		$sql1 = mysql_query("SELECT f_manpower_loading.*, h_employee.id, h_employee.nik, h_employee.firstname, h_employee.midlename, h_employee.lastname, h_employee.department FROM f_manpower_loading, h_employee WHERE f_manpower_loading.employee = h_employee.id AND f_manpower_loading.mp1 LIKE '%$cari%'");
	  	$row_sql1 = mysql_fetch_assoc($sql1);
        ...
        <tr class="tabel_header">
          ...
          <td width="200" rowspan="2" align="center">NAMA</td>
        ...
        <tr class="tabel_header">
          <td width="17" align="center" class="tabel_header">1</td>
          <td width="17" align="center" class="tabel_header">2</td>
          <td width="17" align="center" class="tabel_header">3</td>
          <td width="17" align="center" class="tabel_header">4</td>
          <td width="17" align="center" class="tabel_header">5</td>
          <td width="17" align="center" class="tabel_header">6</td>
          <td width="17" align="center" class="tabel_header">7</td>
          <td width="17" align="center" class="tabel_header">8</td>
          <td width="17" align="center" class="tabel_header">9</td>
          ...
          <td width="17" align="center" class="tabel_header">19</td>
	...
	?>
      ...
      <table width="436" border="0">
        ...
        <tr class="tabel_header">
          <td width="30">No</td>
          <td width="225">Lokasi</td>
          <td width="167">Kode Produksi</td>
        </tr>
        <?php do { ?>
        <tr class="tabel_body">
          <?php $a=$a+1 ?>
          <td align="center"><strong><?php echo $a; ?></strong></td>
          <td><?php echo $row_Recordset3['nama_site']; ?></td>
          <td align="center"><?php echo $row_Recordset3['prod_code']; ?></td>
          </tr>
