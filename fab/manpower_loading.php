...
<table width="1202" class="buatform">
  <tr>
    ...
    <td width="386"><div <?php // id ?>id="<?php echo $row_Recordset1['id']; ?>-day_date">
      <?php // value ?>
      <?php echo $row_Recordset1['month']; ?></div></td>
    <td width="81"><strong>Note </strong></td>
    <td width="10">:</td>
    <td width="639"><div class="headeredit_area" id="<?php echo $row_Recordset1['id']; ?>-note"><?php echo $row_Recordset1['note']; ?></div></td>
  </tr>
  
</table>
<p>&nbsp;</p>
<table width="1260" id="celebs">
<thead>
  <tr class="tabel_header">
    ...
    <td colspan="31" align="center"><?php echo $row_Recordset1['month']; ?></td>
...
<tbody>  
  ...
  <tr class="tabel_body">
    ...
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp1"><?php echo $row_Recordset2[mp1]; ?></div></td>
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp2"><?php echo $row_Recordset2[mp2]; ?></div></td>
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp3"><?php echo $row_Recordset2[mp3]; ?></div></td>
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp4"><?php echo $row_Recordset2[mp4]; ?></div></td>
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp5"><?php echo $row_Recordset2[mp5]; ?></div></td>
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp6"><?php echo $row_Recordset2[mp6]; ?></div></td>
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp7"><?php echo $row_Recordset2[mp7]; ?></div></td>
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp8"><?php echo $row_Recordset2[mp8]; ?></div></td>
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp9"><?php echo $row_Recordset2[mp9]; ?></div></td>
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp10"><?php echo $row_Recordset2[mp10]; ?></div></td>
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp11"><?php echo $row_Recordset2[mp11]; ?></div></td>
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp12"><?php echo $row_Recordset2[mp12]; ?></div></td>
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp13"><?php echo $row_Recordset2[mp13]; ?></div></td>
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp14"><?php echo $row_Recordset2[mp14]; ?></div></td>
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp15"><?php echo $row_Recordset2[mp15]; ?></div></td>
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp16"><?php echo $row_Recordset2[mp16]; ?></div></td>
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp17"><?php echo $row_Recordset2[mp17]; ?></div></td>
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp18"><?php echo $row_Recordset2[mp18]; ?></div></td>
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp19"><?php echo $row_Recordset2[mp19]; ?></div></td>
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp20"><?php echo $row_Recordset2[mp20]; ?></div></td>
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp21"><?php echo $row_Recordset2[mp21]; ?></div></td>
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp22"><?php echo $row_Recordset2[mp22]; ?></div></td>
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp23"><?php echo $row_Recordset2[mp23]; ?></div></td>
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp24"><?php echo $row_Recordset2[mp24]; ?></div></td>
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp25"><?php echo $row_Recordset2[mp25]; ?></div></td>
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp26"><?php echo $row_Recordset2[mp26]; ?></div></td>
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp27"><?php echo $row_Recordset2[mp27]; ?></div></td>
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp28"><?php echo $row_Recordset2[mp28]; ?></div></td>
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp29"><?php echo $row_Recordset2[mp29]; ?></div></td>
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp30"><?php echo $row_Recordset2[mp30]; ?></div></td>
    <td align="center"><div class="coreeditanggal_select" id="<?php echo $row_Recordset2['id']; ?>-mp31"><?php echo $row_Recordset2[mp31]; ?></div></td>
    <td><div class="coreedit_area" id="<?php echo $row_Recordset2['id']; ?>-keterangan"><?php echo $row_Recordset2['keterangan'];?></div></td>
    <td width="10" align="center"><a style="text-decoration:none; color:#F00AAA" href="delrow_manpower_loading.php?header=<?php echo $_GET['data']; ?>&amp;data=<?php echo $row_Recordset2['id']; ?>&amp;tb=f_manpower_loading"><strong>x</strong></a></td>
  </tr>
  <?php
  ...
  <tr>
    <td align="center"><a style="text-decoration:none; color:#09F" href="addrow_manpower_loading.php?data=<?php echo $_GET['data']; ?>&amp;fld=idheader&amp;tb=f_manpower_loading"><strong>+</strong></a></td>
  </tr>
</table>
<p>&nbsp;</p>
...
<table width="1115" class="General">
  <tr>
    ...
    <p class="hidentext">.</p>
    <p class="hidentext">.</p>
      <div class="headeredit" id="<?php echo $row_Recordset1['id']; ?>-checked_by"><?php echo $row_Recordset1['checked_by']; ?></div>
    </td>
    <td width="162"><p>Approve By :                 
        <p class="hidentext">.</p>
    <p class="hidentext">.</p>
    <p class="hidentext">.</p>
    <div class="headeredit" id="<?php echo $row_Recordset1['id']; ?>-approved_by"><?php echo $row_Recordset1['approved_by']; ?></div></td>
  </tr>
</table>
