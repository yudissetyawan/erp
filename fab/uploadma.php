    ...
    if(isset($_POST[submit2])){
     $direktori = '../fab/upload/ma/'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['filema']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filema']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filema']['tmp_name']; //Nama file sementara
