    ...
    if(isset($_POST[submit4])){
     $direktori = '../fab/upload/ik/'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['fileikblast']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['fileikblast']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['fileikblast']['tmp_name']; //Nama file sementara
