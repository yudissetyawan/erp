...
<tr>
    ...
    <td width="891" align="right" valign="bottom"><table width="400" border="0" align="right" cellpadding="1" cellspacing="1">
      <tr>
        ...
        <td width="107" class="demoHeaders"><a href="../logout.php">Logout</a></td>
        <td width="18">|</td>
      </tr>
    </table></td><tr>
    <td id="font" class="tabel_index">Manpower Allocation</td>
    <td colspan="2" align="right" class="tabel_index" id="font"><table width="500" height="17" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
  ...
  <tr>
    <td colspan="4" align="left" class="General" id="font"><div id="TabbedPanels1" class="TabbedPanels">
      ...
      <div class="TabbedPanelsContentGroup">
        <div class="TabbedPanelsContent"><iframe style="border:thin" width="1200" height="405" src="lokasi.php"></iframe></div>
        <div class="TabbedPanelsContent"><iframe style="border:thin" width="1200" height="405" src="mpl_headerselection.php"></iframe></div>
        <div class="TabbedPanelsContent"><iframe style="border:thin" width="1200" height="405" src="mpl_headerforselection.php"></iframe></div>
      </div>
<p>&nbsp;</p>
    </div></td>
  </tr>
  ...
  <tr>
    <td width="205">&nbsp;</td>
    <td width="160">&nbsp;</td>
    <td width="891" align="right" class="General" id="font">&copy; 2012 Bukaka Balikpapan</td>
  </tr>
</table>
<script type="text/javascript">
<!--
