...
<table width="1032" border="0" align="center">
  ...
  <tr>
    ...
    <div id="tab-container" class='tab-container'>
			<ul class='etabs'>
				<li class='tab'><a href="#tabs1-vp">Applicant</a></li>
				<li class='tab'><a href="#tabs1-ic">Selection</a></li>
			</ul>
            
		<div class='panel-container'>
			<div id="tabs1-vp">
				<iframe src="pagingrecruitment.php" frameborder="0" width="1200" height="550"> </iframe>
			</div>
			<div id="tabs1-ic">
				<iframe src="selection.php" frameborder="0" width="1200" height="600"> </iframe>
            </div>
		</div>
 	</div>
    </td>
