...
$query_Recordset1 = "SELECT * FROM h_employee WHERE h_employee.firstname <> 'Administrator' AND h_employee.code='K' ORDER BY h_employee.department ASC";
$Recordset1 = mysql_query($query_Recordset1, $core) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
$totalRows_Recordset1 = mysql_num_rows($Recordset1);mysql_select_db($database_core, $core);
$query_Recordset1 = "SELECT * FROM h_employee WHERE h_employee.firstname <> 'Administrator' AND h_employee.code='MK' ORDER BY h_employee.department ASC";
$Recordset1 = mysql_query($query_Recordset1, $core) or die(mysql_error());
$row_Recordset1 = mysql_fetch_assoc($Recordset1);
...
<link rel="shortcut icon" href="karyawan/img/favicon.ico">
...
<body>
<p><a href="karyawan/inputkaryawan.php" id="dialog_link" class="ui-state-default ui-corner-all"><span class="ui-icon ui-icon-plusthick"></span>Add New Employee</a></p>
	...
	<div class="container">
	 ...
	 <?php do { ?>
	    <tr class="tabel_body">
	      ...
	      <td align="center"><a href="karyawan/viewdata_karyawan.php?data=<?php echo $row_Recordset1['id']; ?>" target="_blank"><strong>Detail </strong></a>| <strong><a href="#" onClick="MM_openBrWindow('karyawan/edit_employee.php?data=<?php echo $row_Recordset1['id']; ?>','','width=600,height=550')">Edit</a></strong></td>
        </tr>
