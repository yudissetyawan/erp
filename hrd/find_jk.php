    ...
    <td width="1017"><p align="center"><strong>PENCARIAN DATA PELAMAR</strong></p>
	  ...
	  ?>
        <tr class="tabel_body">
          ...
          <td width="67">
          <a href="viewcvdetailprint.php?data=<?php echo $sql1['id']; ?>" target="new">
