    ...
    if(isset($_POST[submit10])){
     $direktori = '../hrd/upload/'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['fileft']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['fileft']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['fileft']['tmp_name']; //Nama file sementara
