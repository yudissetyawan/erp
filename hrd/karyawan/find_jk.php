...
$query_sql1 = sprintf("SELECT * FROM h_employee WHERE id = %s", GetSQLValueString($colname_sql1, "text"));
...
<table width="1000" border="1" cellspacing="0" cellpadding="0" class="buatform">
  <tr>
    <td width="1017"><p align="center"><strong>Please Select Gender of Employee</strong></p>
      ...
      <p>
        <?
	  $sql=mysql_query("SELECT h_employee.id, h_employee.firstname, h_employee.midlename,h_employee.lastname, h_employee.status, h_employee.department, h_employee.nik, h_datapribadi.id_h_employee,  h_datapribadi.jk FROM h_employee INNER JOIN h_datapribadi WHERE (h_employee.id=h_datapribadi.id_h_employee) AND (h_datapribadi.jk LIKE '%$cari%')");
	  ...
	  ?>
      <table width="618" border="0" cellspacing="1" cellpadding="0" class="table" id="celebs">
      <thead>
	  ...
	  ?>
        <tr class="tabel_body">
          ...
          <td width="67">
          <a href="viewdata_karyawan.php?data=<?php echo $sql1['id']; ?>" target="new">
<? echo $sql1[firstname]. ' ' .$sql1[midlename].' '.$sql1[lastname];?> </b></a>
