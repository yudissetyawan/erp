...
if (isset($_POST['firstname'])) {
  $colname_Recordset1 = $_POST['firstname'];
}
mysql_select_db($database_core, $core);
$query_Recordset1 = sprintf("SELECT * FROM h_employee WHERE firstname = %s ORDER BY h_employee.nik DESC", GetSQLValueString($colname_Recordset1, "text"));
...
<form action="viewemployee.php" method="post" name="pencarian" id="pencarian">
