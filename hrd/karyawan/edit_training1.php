...
<input type="radio" name="jk" value="2" <?php echo ($row_Recordset1['kategori']=='2')?'checked':'' ?> size="17">Skill Training</td>
              ...
              <tr>
                ...
                <td>:</td>
                <td><input name="date" type="text" id="tanggal8" value="<?php echo functddmmmyyyy($row_Recordset1['date']); ?>" /> <i>(dd mmm yyyy)</i></td>
              ...
              <tr>
                ...
                <td>:</td>
                <td><input name="exp_date" type="text" id="tanggal9" value="<?php echo functddmmmyyyy($row_Recordset1['exp_date']); ?>" /> <i>(dd mmm yyyy)</i></td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
              </tr>
