...
mysql_select_db($database_core, $core);
$query_Recordset2 = sprintf("SELECT * FROM h_absen WHERE idheader = %s AND h_absen.h1= '.$row_Recordset3[kode_lokasi].' ", GetSQLValueString($colname_Recordset2, "int"));
...
<table border="0" class="table" id="celebs" width="256">
  ...
  <tbody>
    ...
    <tr class="tabel_body">
      ...
      <td width="369"><?php echo $row_Recordset3['kode_lokasi']; ?></td>
