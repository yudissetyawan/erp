...
$query_Recordset1 = "SELECT * FROM h_employee WHERE code = 'K' ORDER BY firstname ASC";
...
mysql_select_db($database_core, $core);
$query_Recordset2 = "SELECT * FROM h_employee WHERE id='".$_GET['data']."' ORDER BY firstname ASC";
