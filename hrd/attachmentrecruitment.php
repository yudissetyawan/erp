...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO dms (idms, id_departemen, inisial_pekerjaan, `date`, fileupload) VALUES (%s, %s, %s, %s, %s)",
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form4")) {
  $insertSQL = sprintf("INSERT INTO dms (idms, id_departemen, inisial_pekerjaan, `date`, fileupload) VALUES (%s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['id_dept2'], "text"),
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form6")) {
  $insertSQL = sprintf("INSERT INTO dms (idms, id_departemen, inisial_pekerjaan, `date`, fileupload) VALUES (%s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString($_POST['id_dept3'], "text"),
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form7")) {
  $insertSQL = sprintf("INSERT INTO dms (idms, id_departemen, inisial_pekerjaan, `date`, fileupload) VALUES (%s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['idmsps'], "text"),
                       GetSQLValueString($_POST['id_dept4'], "text"),
...
mysql_select_db($database_core, $core);
$query_Recordset2 = sprintf("SELECT * FROM h_recruitment WHERE id = %s", GetSQLValueString($colname_Recordset2, "int"));
 ...
 <div class='panel-container'>
  <div id="tabs1-ps">
     ...
     <form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST">
       <input name="idmsps" type="text" id="idmsps" value="<?php echo $row_Recordset2['id']; ?>"  />
       ...
       <input type="text" name="id_dept" id="id_dept" value="HRD_rec" />
  ...
  <div id="tabs1-mc">
   ...
   <form id="form4" name="form4" method="POST" action="<?php echo $editFormAction; ?>">
     <input name="idmsmc" type="text" id="idmsmc" value="<?php echo $row_Recordset2['id']; ?>" />
     <input name="nama_filemc" type="text" class="hidentext" id="nama_filemc" value="<?php echo $nama_file;?>"/>
       ...
       <input type="text" name="id_dept2" id="id_dept2" value="HRD_rec" />
<input type="submit" name="submit6" id="submit2" value="Submit" />
  ...
  <div id="tabs1-sp">
   ...
   <form id="form6" name="form6" method="POST" action="<?php echo $editFormAction; ?>">
       <input name="idmssp" type="text" id="idmssp" value="<?php echo $row_Recordset2['id']; ?>" />
       ...
       <input type="text" name="id_dept3" id="id_dept3" value="HRD_rec" />
<input type="submit" name="submit6" id="submit2" value="Submit" />
  ...
  <div id="tabs1-ft">
     ...
     <form action="<?php echo $editFormAction; ?>" id="form7" name="form7" method="POST">
       ...
       <input type="text" name="id_dept4" id="id_dept4" value="HRD_rec" />
