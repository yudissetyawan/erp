...
<table width="1270" border="0" align="center">
  <tr>
    ...
    <td width="746" align="right" valign="top">
    <table width="439" border="0" align="right" cellpadding="1" cellspacing="1">
      <tr class="demoHeaders">
        <td width="8" align="right" valign="bottom">|</td>
        <td width="250" align="right" valign="bottom" class="demoHeaders">Your Logged as <a href="karyawan/viewdata_karyawan_print.php?data=<?php echo $_SESSION['empID']; ?>"><b><?php echo $_SESSION['MM_Username']?></b></a></td>
        ...
        <td align="right" width="60" class="demoHeaders"><a href="../logout.php">Logout</a></td>
  ...
  <tr>
    <td align="right" bgcolor="#8db4e3" class="tabel_index" id="font">HRD/GAFF Menu</td>
    <td colspan="2" align="right" bgcolor="#8db4e3" id="font">
     <table width="400" height="17" border="0" align="left" cellpadding="0" cellspacing="0">
      <tr class="root">
        ...
        <td width="75" align="right" bgcolor="#EFEFEF" class="root">HRD/GAFF</td>
        <td width="285" align="right" bgcolor="#EFEFEF" class="root"><?php
                    	if($_GET[modul]=='project'){
							$content = "Project Handling";
						} elseif ($_GET[modul]=='recruitment'){
							$content = "Recruitment";
						} elseif ($_GET[modul]=='employee'){
							$content = "Employee";
						} elseif ($_GET[modul]=='phonebook'){
							$content = "Phonebook";
						} elseif ($_GET[modul]=='personcert'){
							$content = "Personnel Certification";
  ...
  <tr>
    <td rowspan="2" valign="top">
    	<div class="glossymenu"> 
          <a class="menuitem submenu" href="?modul=timecard">Time Card</a>        
          <a class="menuitem submenu" href="?modul=project">Project Handling</a>
          <a class="menuitem submenu" href="recruitmentnew.php">Recruitment</a>
          <a class="menuitem submenu" href="karyawan/employeenew.php">Employee</a>
          <a class="menuitem submenu" href="?modul=exemployee">Ex - Employee</a>
          <a class="menuitem submenu" href="?modul=phonebook">Phone Book</a>
        <?php // if ($_SESSION['userlvl'] == 'administrator') { ?>
          <a class="menuitem submenu" href="?modul=personcert">Personnel Certification</a>
          <a class="menuitem submenu" href="?modul=absen"><i>Absence</i></a> 
          <a class="menuitem submenu" href="?modul=permission"><i>Permission</i></a>           
        </div>
    </td>
    <td colspan="2"></td>
  </tr>
  <tr>
    <td colspan="2" valign="top"><iframe src="<?php
                    	if ($_GET[modul]=='project'){
							echo "form_hrd.php";
						} elseif ($_GET[modul]=='timecard'){
							echo "absnkary/timecard.php";
						} elseif ($_GET[modul]=='recruitment'){
							echo "recruitment.php";
						} elseif ($_GET[modul]=='permission'){
							echo "surat_izin.php";
						} elseif ($_GET[modul]=='exemployee'){
							echo "exemployee.php";
						} elseif ($_GET[modul]=='phonebook'){
							echo "viewphonebook.php";
						} elseif ($_GET[modul]=='personcert'){
							echo "view_personnel_certificate_header.php";
						} elseif ($_GET[modul]=='unapproved'){
							echo "../tm/unapproved_crf.php";
						} elseif ($_GET[modul]=='notif'){
							echo "../prj/bacanotif.php?data=$usrid";
						} elseif ($_GET[modul]=='absen'){
							echo "absnkary/header-absen.php";
						} 
						  elseif ($_GET[modul]=='shirt'){
							echo "../hrd/karyawan/pagingemployeeshirt.php";
						  }else {
							echo"flash/hrd.html";
						}
