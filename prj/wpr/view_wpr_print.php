...
mysql_select_db($database_core, $core);
$query_Recordset2 = sprintf("SELECT * FROM pr_wpr_activities WHERE id_wpr_tanggal = %s", GetSQLValueString($colname_Recordset2, "int"));
...
function alarm()
{
alert("Press 'Ctrl + P' to print this document");
}
</script>
...
<table width="1728" height="512" border="1">
  ...
  <tr>
    ...
    <td colspan="3" height="253"><table height="253" border="0" cellspacing="2">
      <tr class="headerwpr" >
    ...
    <td colspan="5"><table border="0" height="253" cellspacing="2">
      <tr>
  ...
  <tr>
    ...
    <td width="860" rowspan="3"><iframe frameborder="0" width="730" height="650" src="../chart/line.php?data=<?php echo $row_Recordset13['id']; ?>"></iframe></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="2" align="center"><iframe frameborder="0"  width="400" height="230" src="../chart/pie_summary.php?data=<?php echo  $row_Recordset13['id']; //$row_Recordset3['id_wpr_tanggal']; ?>"> </iframe>
    <iframe frameborder="0" width="470" height="230" src="../chart/pie.php?data=<?php echo $row_Recordset13['id']; //$row_Recordset3['id_wpr_tanggal']; ?>"></iframe></td>
  </tr>
</table>
</p>
</body>
