...
<table width="1212" border="0" align="center">
  ...
  <tr>
    <td align="right" bgcolor="#8db4e3" class="tabel_index" id="font">Project Menu</td>
    <td colspan="2" align="right" bgcolor="#8db4e3" id="font"><table height="17" border="0" align="left" cellpadding="0" cellspacing="0">
      <tr class="tabel_index">
        <td width="42" bgcolor="#EFEFEF" class="root"><a href="../home.php">Home</a></td>
        <td width="10" align="right" bgcolor="#EFEFEF" class="root">|</td>
        <td width="43" align="right" bgcolor="#EFEFEF" class="root">Project</td>
        <td width="164" align="right" bgcolor="#EFEFEF" class="root"><?php
                    	if($_GET[modul]=='project'){
							$content="Project Handling";
						}
						elseif ($_GET[modul]=='progres'){
							$content="Progress Workshop";
						}
						elseif ($_GET[modul]=='wpr'){
							$content="Weekly Progress Report";
						}
						elseif ($_GET[modul]=='si'){
  ...
  <tr>
    ...
    <!--<a class="menuitem submenu" href="?modul=progres">Progress Workshop</a>-->
    <a class="menuitem submenu" href="?modul=wpr">Weekly Progress Report (WPR)</a>
    <a class="menuitem submenu" href="?modul=si"><i>Delivery Instruction (DI)</i></a>
    <a class="menuitem submenu" href="?modul=qsop" title="QSOP & PPHA"><i>SOP Project</i></a>
    </span></div></td><br />
	</span></div><td width="0"></td>
    <td width="10" colspan="2"> </td>
  </tr>
  <tr>
    <td colspan="2" valign="top"><iframe src="<?php
                    	if($_GET[modul]=='project'){
							echo "form_project.php";
						}
						elseif($_GET[modul]=='progres'){
							echo "progress_header.php";
						}
						elseif($_GET[modul]=='wpr'){
							echo "view_headerwpr.php";
						}
						elseif ($_GET[modul]=='unapproved'){
							echo "../tm/unapproved_crf.php";
						}
						elseif ($_GET[modul]=='si'){
							echo "ship_inst/view_si_header.php";
						}
						elseif ($_GET[modul]=='qsop'){
							echo "../hse/qsop_view.php";
						}
						elseif($_GET[modul]=='notif'){
							echo "bacanotif.php?data=$usrid";
						}
						else {
							echo"flash/project.html";
						}
