    ...
    if(isset($_POST[submit2])){
     $direktori = '../prj/upload/mc'; //Folder penyimpanan file
     $max_size  = 100000000*2; //Ukuran file maximal 10mb
     $nama_file = $_FILES['filemc']['name']; //Nama file yang akan di Upload
     $file_size = $_FILES['filemc']['size']; //Ukuran file yang akan di Upload
     $nama_tmp  = $_FILES['filemc']['tmp_name']; //Nama file sementara
