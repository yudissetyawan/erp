...
-->
  ...
  <table width="1208" border="0" cellpadding="0" cellspacing="2">
    ...
    <tr>
      <td colspan="13" class="General"><table width="769" border="0" cellpadding="0" cellspacing="2">
        <tr class="tabel_header">
          <td width="120">&nbsp;</td>
        ...
        <tr  class="tabel_header">
          ...
          <td width="147"  class="tabel_header" >Remark</td>
        </tr>
        <tr class="tabel_body">
          <td><? if ($row_sch['drawingprogress']=='') {echo "Design";} else {echo  "<a href=../eng/crfdesign.php?data=$_GET[data]>Design</a>";} ?></td>
          ...
          <td><?php echo $row_sch['remark design']; ?></td>
        </tr>
        <tr class="tabel_body">
          ...
          <td><?php echo $row_sch['remark_drawing']; ?></td>
        </tr>
        <tr class="tabel_body">
          ...
          <td><?php echo $row_sch['remark_itp']; ?></td>
        </tr>
        <tr class="tabel_body">
          <td>Material</td>
          ...
          <td><?php echo $row_sch['remark_material']; ?></td>
        </tr>
        <tr class="tabel_body">
          ...
          <td><?php echo $row_sch['remark_fab']; ?></td>
        </tr>
        <tr class="tabel_body">
          <td>Test/NDE</td>
          ...
          <td><?php echo $row_sch['remark_test']; ?></td>
        </tr>
        <tr class="tabel_body">
          ...
          <td><?php echo $row_sch['remark_blasting']; ?></td>
        </tr>
        <tr class="tabel_body">
          <td>Delivery</td>
          ...
          <td><?php echo $row_sch['remark_delivery']; ?></td>
        </tr>
        <tr class="tabel_body">
          <td>Instalation</td>
          ...
          <td><?php echo $row_sch['remark_installation']; ?></td>
        </tr>
        <tr>
          <td colspan="6" class="tabel_header">Others :</td>
        </tr>
        <tr class="tabel_body">
          ...
          <td><?php echo $row_sch['remark_other1']; ?></td>
        </tr>
        <tr class="tabel_body">
          ...
          <td><?php echo $row_sch['remark_other2']; ?></td>
        </tr>
        <tr class="tabel_body">
          ...
          <td><?php echo $row_sch['remark_other3']; ?></td>
        </tr>
        <tr class="tabel_body">
