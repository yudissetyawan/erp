...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO pr_wpr_comulative (id_headerwpr, id_wpr_tanggal, cumm_plan_e1, cumm_plan_p2, cumm_plan_f3, cumm_plan_i4, cumm_plan_m5) VALUES (%s, %s, %s, %s, %s, %s, %s)",
...
mysql_select_db($database_core, $core);
$query_Recordset2 = sprintf("SELECT * FROM pr_wpr_corecomulative WHERE tanggal = %s AND pr_wpr_corecomulative.id_jenis=1", GetSQLValueString($colname_Recordset2, "text"));
...
<form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>">
  ...
  <tr class="header_description">
    ...
    <td class="header_description" align="center"><input type="hidden" style="border:thin" name="eng" id="eng" value="<?php echo $row_Recordset3['cumm_plan_e1']; ?>" /><?php echo $row_Recordset3['cumm_plan_e1']; ?></td>
  </tr>
  <tr class="tabel_body">
  ...
  <tr class="header_description">
    ...
    <td class="header_description" align="center"><input name="proc" type="hidden" style="border:thin" id="proc" value="<?php echo $row_Recordset3['cumm_plan_p2']; ?>" size="10" /><?php echo $row_Recordset3['cumm_plan_p2']; ?></td>
  </tr>
  <tr class="tabel_body">
    <td>II.A.</td>
  ...
  <tr class="header_description">
    ...
    <td class="header_description" align="center"><input type="hidden" style="border:thin" name="fab" id="fab" value="<?php echo $row_Recordset3['cumm_plan_f3']; ?>" size="10" /><?php echo $row_Recordset3['cumm_plan_f3']; ?></td>
  </tr>
  <tr class="tabel_body">
  ...
  <tr class="header_description">
    ...
    <td class="header_description" align="center"><input type="hidden" style="border:thin" name="inst" id="inst" value="<?php echo $row_Recordset3['cumm_plan_i4']; ?>" size="10" /><?php echo $row_Recordset3['cumm_plan_i4']; ?></td>
  </tr>
  <tr class="tabel_body">
  ...
  <tr class="header_description">
    <td class="header_description">V.</td>
    <td class="header_description">Miscellanous</td>
    <td class="header_description" align="center"><input type="hidden" style="border:thin" name="misc" id="misc" value="<?php echo $row_Recordset3['cumm_plan_m5']; ?>"size="10" /><?php echo $row_Recordset3['cumm_plan_m5']; ?></td>
  </tr>
  <tr class="tabel_body">
  ...
  <tr class="tabel_header">
    ...
    <td class="tabel_header"><input type="text" style="border:thin" name="total" id="total" value="<?php $allcum= $row_Recordset3['cumm_plan_e1']+$row_Recordset3['cumm_plan_p2']+$row_Recordset3['cumm_plan_f3']+$row_Recordset3['cumm_plan_i4']+$row_Recordset3['cumm_plan_m5']; echo number_format($allcum,2) ?>" size="10" /></td>
  </tr>
  <tr>
    <?php $i=$i+1; ?>
    <td class=""><input type="hidden" name="jenisid2" value="1" /></td>
