...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO dms (nocrf, inisial_pekerjaan, `date`, fileupload) VALUES (%s, %s, %s, %s)",
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form6")) {
  $insertSQL = sprintf("INSERT INTO dms (nocrf, inisial_pekerjaan, `date`, fileupload) VALUES (%s, %s, %s, %s)",
                       GetSQLValueString($_POST['idmsinst'], "text"),
                       GetSQLValueString($_POST['inisialinst'], "text"),
                       GetSQLValueString($_POST['dateinst'], "text"),
                       GetSQLValueString($_POST['nama_fileinst'], "text"));
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form6")) {
  $updateSQL = sprintf("UPDATE a_crf_schedulle SET file_instalation=%s WHERE crf=%s",
                       GetSQLValueString($_POST['nama_fileinst'], "text"),
                       GetSQLValueString($_POST['idmsinst'], "text"));
    ...
    <?php
		if ($_GET[modul]=='unapproved'){
          ...
          <div id="tab-container" class='tab-container'>
            <ul class='etabs'>
               <li class='tab'><a href="#tabs1-ps">Progress</a></li>
               <li class='tab'><a href="#tabs1-mc">Monitoring Activity</a></li>
               <li class='tab'><a href="#tabs1-sp">Site Project</a></li>
               <li class='tab'><a href="#tabs1-inst">Installation</a></li>
            </ul>
             <div class='panel-container'>
              <div id="tabs1-ps">
                 ...
                 <form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST">
                   <input type="hidden" name="idmsps" id="idmsps" value="<?php echo $row_recordset1['idms'];?>" />
                   ...
                   <input name="inisialps" type="text" class="hidentext" id="inisialps" value="ps"/>
              ...
              <div id="tabs1-mc">
               ...
               <form id="form4" name="form4" method="POST" action="<?php echo $editFormAction; ?>">
                   <input type="hidden" name="idmsmc" id="idmsmc" value="<?php echo $row_recordset1['idms'];?>" />
                   ...
                   <input name="inisialmc" type="text" class="hidentext" id="inisialmc" value="mc"/>
              ...
              <div id="tabs1-sp">
               ...
               <form id="form6" name="form6" method="POST" action="<?php echo $editFormAction; ?>">
                   <input type="hidden" name="idmssp" id="idmssp" value="<?php echo $row_recordset1['idms'];?>" />
                   ...
                   <input name="inisialsp" type="text" class="hidentext" id="inisialsp" value="sp"/>
                   <input type="submit" name="submit6" id="submit2" value="Submit" />
              ...
              <div id="tabs1-inst">
                <h2>Installation</h2>
                <?php {include "uploadinst.php";}?>
                <form method="post" enctype="multipart/form-data" name="form5" class="General" id="form2">
                  Attachment File:
                  <input name="fileinst" type="file" style="cursor:pointer;" />
                  <input type="submit" name="submit4" value="Upload" />
                </form>
                <form id="form2" name="form6" method="POST" action="<?php echo $editFormAction; ?>">
                  <input type="hidden" name="idmsinst" id="idmsinst" value="<?php echo $row_recordset1['idms'];?>" />
                  <input name="nama_fileinst" type="text" class="hidentext" id="nama_fileinst" value="<?php echo $nama_file;?>"/>
                  <input name="dateinst" type="text" class="hidentext" id="dateinst" value="<?php echo $tanggal;?>"/>
                  <input name="inisialinst" type="text" class="hidentext" id="inisialinst" value="inst"/>
                  <input type="submit" name="submit4" id="submit3" value="Submit" />
                  <input type="hidden" name="MM_insert" value="form6" />
